...
<!-- DO NOT EDIT: This section is automatically generated by core/eng/common/scripts/labels/sync-labels.ts, update core/eng/common/config/labels.ts run pnpm sync-labels to update -->
...
| `emitter:java`               | #c5112f | Issues for @azure-tools/typespec-java emitter                                     |
