...
const rawRedirects = {
  ...
  // Linter rule pages are now generated by tspd using the rule name. A few rules
  // were historically documented under a different slug than their rule name.
  "/docs/libraries/azure-core/rules/prevent-format/": `/docs/libraries/azure-core/rules/no-format/`,
  "/docs/libraries/azure-resource-manager/rules/delete-operation-response-codes/": `/docs/libraries/azure-resource-manager/rules/arm-delete-operation-response-codes/`,
