...
| arguments? | `string`                                                                                  | JSON-encoded arguments passed to the function (tool). Applies to `FunctionCall` items.                            |
...
| arguments? | `string`                                                                                  | JSON-encoded arguments passed to the function (tool). Applies to `FunctionCall` items. Read-only.                            |
