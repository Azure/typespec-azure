...
- [`@armResourceRoute`](./decorators.md#@Azure.ResourceManager.Legacy.armResourceRoute)
...
- [`ArmRouteOptions`](./data-types.md#Azure.ResourceManager.Legacy.ArmRouteOptions)
