...
- [`CreateOrUpdateAsync`](./interfaces.md#Azure.ResourceManager.Private.PrivateEndpoints.CreateOrUpdateAsync)
- [`DeleteAsyncBase`](./interfaces.md#Azure.ResourceManager.Private.PrivateEndpoints.DeleteAsyncBase)
