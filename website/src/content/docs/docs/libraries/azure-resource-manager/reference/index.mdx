...
- [`ArmCustomPatchAsync`](./interfaces.md#Azure.ResourceManager.Legacy.ArmCustomPatchAsync)
- [`ArmCustomPatchSync`](./interfaces.md#Azure.ResourceManager.Legacy.ArmCustomPatchSync)
