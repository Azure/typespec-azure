...
- [`@previewVersion`](./decorators.md#@Azure.Core.previewVersion)
- [`@uniqueItems`](./decorators.md#@Azure.Core.uniqueItems)
...
- [`@overrideApiVersion`](./decorators.md#@Azure.Core.Legacy.overrideApiVersion)
