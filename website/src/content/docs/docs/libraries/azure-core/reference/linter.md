...
| [`@azure-tools/typespec-azure-core/use-date-api-version`](../rules/use-date-api-version.md)                                       | Service API versions must use YYYY-MM-DD date format with an optional -preview suffix.                                                               |
