...
| [`@azure-tools/typespec-azure-core/no-identical-summary-and-description`](../rules/no-identical-summary-and-description.md)       | Operations must not use identical summary and description text.                                                                                      |
