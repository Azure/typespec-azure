...
| [`@azure-tools/typespec-azure-core/no-union-expr`](/libraries/azure-core/rules/no-union-expr.md)                                 | Azure services should not define union expression but create a declaration.                                                                          |
