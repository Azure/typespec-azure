...
| [`@azure-tools/typespec-azure-core/no-case-mismatch`](/libraries/azure-core/rules/no-case-mismatch.md)                           | Validate that no 2 types have the same name with different casing.                                                                                   |
