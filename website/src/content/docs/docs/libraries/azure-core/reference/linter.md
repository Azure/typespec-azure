...
| [`@azure-tools/typespec-azure-core/no-version-in-route`](../rules/no-version-in-route.md)                                         | Do not include an API version segment in operation routes.                                                                                           |
| [`@azure-tools/typespec-azure-core/api-version-date-format`](../rules/api-version-date-format.md)                                 | Service API versions must use YYYY-MM-DD date format with an optional -preview suffix.                                                               |
| [`@azure-tools/typespec-azure-core/no-dollar-prefixed-query-params`](../rules/no-dollar-prefixed-query-params.md)                 | Do not prefix standard collection query parameter names with a dollar sign.                                                                          |
