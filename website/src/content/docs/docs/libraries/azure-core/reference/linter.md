...
| [`@azure-tools/typespec-azure-core/no-unnamed-union`](/libraries/azure-core/rules/no-unnamed-union.md)                                 | Azure services should not define union expression but create a declaration.                                                                          |
