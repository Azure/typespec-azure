...
| [`@azure-tools/typespec-azure-core/enum-instead-of-boolean`](../rules/enum-instead-of-boolean.md)                                 | Boolean properties should use descriptive extensible enums when semantic values matter.                                                              |
