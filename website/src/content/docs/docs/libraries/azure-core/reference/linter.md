...
| [`@azure-tools/typespec-azure-core/no-unnamed-types`](../rules/no-unnamed-types.md)                                               | Azure services should not have anonymous models or union expressions. Define them as named declarations.                                             |
