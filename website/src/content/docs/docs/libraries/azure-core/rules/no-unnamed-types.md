...
@azure-tools/typespec-azure-core/no-unnamed-types
```

Azure services should not define anonymous models or union expressions inline. Instead, types must be defined as named declarations.
