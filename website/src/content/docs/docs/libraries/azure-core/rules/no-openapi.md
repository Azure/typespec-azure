...
| `@extension("x-ms-client-flatten", ` | TCGC [`@flattenProperty`](../../typespec-client-generator-core/reference/decorators.md#flattenproperty-azureclientgeneratorcorelegacyflattenproperty)                                |
...
| `@extension("x-ms-identifiers", `    | Use [`@identifiers`](../../azure-resource-manager/reference/decorators.md#identifiers-azureresourcemanageridentifiers)                                             |
