...
| [`@azure-tools/typespec-client-generator-core/scope-options-migration`](../rules/scope-options-migration.md)           | Suggests migrating the legacy positional string `scope` argument to the typed `#{ scope: ... }` options bag. |
