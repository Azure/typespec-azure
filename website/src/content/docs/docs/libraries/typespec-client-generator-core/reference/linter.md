...
| [`@azure-tools/typespec-client-generator-core/no-url-suffix`](../rules/no-url-suffix.md)                   | Properties ending with 'Url' should use 'Uri' suffix instead to follow .NET naming conventions. |
