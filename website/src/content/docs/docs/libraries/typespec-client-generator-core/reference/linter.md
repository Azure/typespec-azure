...
| [`@azure-tools/typespec-client-generator-core/dotnet-no-url-suffix`](../rules/dotnet-no-url-suffix.md)     | Properties ending with 'Url' should use 'Uri' suffix instead to follow .NET naming conventions. |
