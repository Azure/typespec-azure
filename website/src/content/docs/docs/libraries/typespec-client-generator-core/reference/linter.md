...
| [`@azure-tools/typespec-client-generator-core/use-union-hierarchy`](../rules/use-union-hierarchy.md)                   | Named unions should declare an extends constraint, with model variants inheriting from the base and belonging to only one union hierarchy. |
