...
| [`@azure-tools/typespec-client-generator-core/use-model-inheritance`](../rules/use-model-inheritance.md)               | Model variants of a union with a model extends constraint should explicitly inherit from the base model. |
