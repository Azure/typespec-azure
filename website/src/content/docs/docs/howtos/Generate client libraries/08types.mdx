...
class RequestOptions(_model_base.Model):
    ...
    :type tier: str
    :param enableRetry: Whether to enable retry. Defaults to False.
    :type enableRetry: bool
    """

    timeout: Optional[int] = rest_field(default=30)
    """Request timeout in seconds."""

    tier: Optional[str] = rest_field(default="standard")
    """Service tier."""

    enableRetry: Optional[bool] = rest_field(default=False)
...
export interface RequestOptions {
  ...
  tier?: string;
  /** Whether to enable retry. Default: false */
  enableRetry?: boolean;
}

export function requestOptionsSerializer(item: RequestOptions): any {
  return {
    timeout: item["timeout"] ?? 30,
    tier: item["tier"] ?? "standard",
    enableRetry: item["enableRetry"] ?? false,
  };
}
```
...
public final class RequestOptions implements JsonSerializable<RequestOptions> {
    ...
    /**
     * Get the timeout property: Request timeout in seconds.
     *
    ...
    /**
     * Set the timeout property: Request timeout in seconds.
     *
    ...
    /**
     * Get the tier property: Service tier.
     *
    ...
    /**
     * Set the tier property: Service tier.
     *
     * @param tier the tier value to set.
     * @return the RequestOptions object itself.
     */
    public RequestOptions setTier(String tier) {
        this.tier = tier;
        return this;
    }

    /**
     * Get the enableRetry property: Whether to enable retry.
     *
     * @return the enableRetry value.
     */
    ...
    /**
     * Set the enableRetry property: Whether to enable retry.
     *
     * @param enableRetry the enableRetry value to set.
     * @return the RequestOptions object itself.
     */
    public RequestOptions setEnableRetry(Boolean enableRetry) {
...
type RequestOptions struct {
    ...
    // Tier - Service tier. Default: "standard"
    Tier *string `json:"tier,omitempty"`

    // EnableRetry - Whether to enable retry. Default: false
...
op uploadFile(
  @Azure.ClientGenerator.Core.Legacy.clientDefaultValue("application/octet-stream")
  @header
  contentType?: string,
...
def get_items(
    ...
    **kwargs: Any
    ...
    :keyword page_size: Number of items per page. Defaults to 10.
    :paramtype page_size: int
    :keyword sort_order: Sort order for results. Defaults to "desc".
    :paramtype sort_order: str
...
def upload_file(
    ...
    **kwargs: Any
    ...
    :keyword content_type: The content type. Defaults to "application/octet-stream".
...
```csharp
public virtual Response<IReadOnlyList<Item>> GetItems(
    int? pageSize = 10,
...
public virtual Response UploadFile(
    BinaryData fileData,
...
```typescript
export interface GetItemsOptions extends OperationOptions {
...
export interface UploadFileOptions extends OperationOptions {
  /** The content type. Default: "application/octet-stream" */
  contentType?: string;
}

export function getItems(context: Client, options: GetItemsOptions = {}): Promise<Item[]> {
 ...
 * @param sortOrder Sort order for results. Default is "desc".
 * @param requestOptions The options to configure the HTTP request before HTTP client sends it.
 * @return the response.
 */
@ServiceMethod(returns = ReturnType.SINGLE)
public Response<List<Item>> getItemsWithResponse(
    Integer pageSize,
    String sortOrder,
 ...
 * @param contentType The content type. Default is "application/octet-stream".
 * @param requestOptions The options to configure the HTTP request before HTTP client sends it.
 * @return the response.
 */
@ServiceMethod(returns = ReturnType.SINGLE)
public Response<Void> uploadFileWithResponse(
    BinaryData fileData,
    String contentType,
    RequestOptions requestOptions) {
    if (contentType == null) {
...
```go
// GetItemsOptions contains optional parameters for the GetItems method.
type GetItemsOptions struct {
    // PageSize - Number of items per page. Default: 10
    PageSize *int32
    // SortOrder - Sort order for results. Default: "desc"
    SortOrder *string
}

// GetItems retrieves a list of items.
func (c *Client) GetItems(ctx context.Context, options *GetItemsOptions) ([]Item, error) {
    if options == nil {
...
// UploadFileOptions contains optional parameters for the UploadFile method.
...
func (c *Client) UploadFile(ctx context.Context, fileData []byte, options *UploadFileOptions) error {
    if options == nil {
        options = &UploadFileOptions{}
    }
