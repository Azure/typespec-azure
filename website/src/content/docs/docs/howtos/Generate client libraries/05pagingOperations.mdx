...
func (c *Client) ListWithPage(ctx context.Context) (UserList, error) {
    // Implementation to call endpoint and deserialize first page
}

func (c *Client) ListWithPageNext(ctx context.Context, nextLink string) (UserList, error) {
    // Implementation to fetch next page from nextLink URL
}
...
// ListWithPage fetches the first page of users
func (c *Client) ListWithPage(ctx context.Context) (UserList, error)

// ListWithPageNext fetches the next page using a nextLink URL
func (c *Client) ListWithPageNext(ctx context.Context, nextLink string) (UserList, error)
...
// Fetch first page (continuationToken is nil)
func (c *Client) ListWithPage(ctx context.Context, continuationToken *string) (UserList, error)

// Fetch next page using continuationToken
nextToken := userList.ContinuationToken
if nextToken != nil {
    userList, err = client.ListWithPage(ctx, nextToken)
}
