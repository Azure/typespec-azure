...
You need to ensue that there are no naming conflicts between the services being merged. If there are conflicts, you may need to rename the types in the original services to avoid collisions.
:::
