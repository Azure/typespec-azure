...
# Usage Sample
client := NewClient()
client.Feed(context.Background(), &PetStoreClientFeedOptions{})
client.Pet(context.Background(), &PetStoreClientPetOptions{})
...
```go
package petstorerenamed
# petstoreopgrp1_client.go
type OpGrp1Client struct {}
func NewOpGrp1Client() *OpGrp1Client{
  return &OpGrp1Client{}
}
...
# petstoreopgrp2_client.go
type OpGrp2Client struct {}
func NewOpGrp2Client() *OpGrp2Client{
  return &OpGrp2Client{}
}
