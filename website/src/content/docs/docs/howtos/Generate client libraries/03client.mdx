...
func (c *Client) Upload(ctx context.Context, options StorageClientOptions) (*http.Response, error) {}

func (c *Client) Download(ctx context.Context, options StorageClientOptions) (*http.Response, error) {}
```
