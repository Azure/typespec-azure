...
): Promise<__PLACEHOLDER_o27__>;

// Modular classical client layer
export class TestServiceClient {
  createOrReplace(
    name: string,
    resource: __PLACEHOLDER_o45__,
    options: CreateOrReplaceOptionalParams = { requestOptions: {} }
  ): PollerLike<OperationState<__PLACEHOLDER_o45__>, __PLACEHOLDER_o45__>；

  getOperationStatus(
    name: string,
    operationId: string,
    options: GetOperationStatusOptionalParams = { requestOptions: {} }
  ): Promise<__PLACEHOLDER_o46__>;
}
```
