...
```python
from pet_store.dogs import DogsClient
from pet_store.cats import CatsClient
...
```java
import petstore.cats.CatsClient;
import petstore.cats.CatsClientBuilder;
import petstore.dogs.DogsClient;
import petstore.dogs.DogsClientBuilder;

DogsClient dogsClient = new DogsClientBuilder().buildClient();
dogsClient.feed();
dogsClient.pet();

CatsClient catsClient = new CatsClientBuilder().buildClient();
catsClient.feed();
catsClient.pet();
```
