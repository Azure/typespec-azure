...
func (c *Client) Get(ctx context.Context, name string) (*InputModel, error) 
```
...
func (c *Client) GetWithResponse(ctx context.Context, name string, requestOptions map[string]string) (*http.Response, []byte, error) 

func (c *Client) Get(ctx context.Context, name string) (*InputOptions, error)
```
...
func (c *Client) ReadModelWithResponse(ctx context.Context, name string) (*http.Response, []byte, error) 

func (c *Client) ReadModel(ctx context.Context, name string) (*InputModel, error) 
