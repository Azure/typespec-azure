...
namespace TestService
{
  ...
  public partial class TestServiceClient
  {
    ...
    // protocol method
    public virtual Azure.Response Get(MatchConditions matchConditions, RequestContext context);
    public virtual Task<Azure.Response> GetAsync(MatchConditions matchConditions, RequestContext context);
    // convenience method
