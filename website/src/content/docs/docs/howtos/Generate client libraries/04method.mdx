...
```go
// Go do not change behavior based on protocolAPI or convenientAPI
```
...
func (c *Client) PostUser(ctx context.Context, user *User) error {}
...
func Upload(ctx context.Context, user *User) error {}
...
```go
func GetBlobProperties(ctx context.Context, name string, testHeader string) error {}
```
...
func Register(ctx context.Context, schema Schema) error {}
```
...
func ScheduleRepairs(ctx context.Context, widgetName string, info RepairInfo) (*RepairResult, error) {}
```
...
func ScheduleRepairs(ctx context.Context, widgetName string, body RepairInfo) (*RepairResult, error) {}
```
...
func Analyze(ctx context.Context, mode string, image []byte) (*AnalyzeResult, error) {}
func Completions(ctx context.Context, input CompletionInput) (*CompletionResult, error) {}
...
func Get(ctx context.Context, ifMatch, ifNoneMatch *string) (*Response, error) {}
```
