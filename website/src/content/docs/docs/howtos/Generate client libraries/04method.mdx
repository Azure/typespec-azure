...
type ContosoProviderHubClientGetOptions struct {}

type ContosoProviderHubClientGetResponse struct {
	MyModel
}

func Get(ctx context.Context, extendedZoneName string, options *ContosoProviderHubClientGetOptions) (ContosoProviderHubClientGetResponse, error)
