...
### Introduce features in new Api Versions
...
#### Add operation in new Api Version
...
```python
# operation was first intruduced from Api Version 2023-11-02, and is unreachable to client with Api Version 2023_11_01_preview
@distributed_trace
...
#### Add model property in new Api Verison
...
class StableModel(_Model):
    ...
    :ivar stable_feature: Required.
    :vartype stable_feature: str
    :ivar stable_detail: Required.
    :vartype stable_detail: ~my.service.models.StableDetail
    """
