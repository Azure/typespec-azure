...
```java
// TODO: fill in Java example manually — Java emitter currently only includes versions defined in @versioned
```

```go
// TODO: fill in Go example manually — Go emitter does not yet generate a version enum for @clientApiVersions
```
