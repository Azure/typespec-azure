...
- [`HttpResponseStatusOptions`](./data-types.md#Azure.Core.HttpResponseStatusOptions)
- [`HttpResponseStatusPollingOptions`](./data-types.md#Azure.Core.HttpResponseStatusPollingOptions)
