...
```typespec
op Azure.Core.ResourceOperations.ResourceCreateOrReplace(apiVersion: string, resource: Resource): { statusCode: 201, response: Resource } | { statusCode: 200, response: Resource } | ErrorResponse
```
...
```typespec
op Azure.Core.ResourceOperations.LongRunningResourceCreateOrReplace(apiVersion: string, resource: Resource): { statusCode: 201, response: Resource, operationLocation: TypeSpec.Rest.ResourceLocation } | { statusCode: 200, response: Resource, operationLocation: TypeSpec.Rest.ResourceLocation } | ErrorResponse
```
...
```typespec
op Azure.Core.ResourceOperations.ResourceCreateOrUpdate(apiVersion: string, contentType: "application/merge-patch+json", resource: Resource): { statusCode: 201, response: Resource } | { statusCode: 200, response: Resource } | ErrorResponse
```
...
```typespec
op Azure.Core.ResourceOperations.LongRunningResourceCreateOrUpdate(apiVersion: string, contentType: "application/merge-patch+json", resource: Resource): { statusCode: 201, response: Resource, operationLocation: TypeSpec.Rest.ResourceLocation } | { statusCode: 200, response: Resource, operationLocation: TypeSpec.Rest.ResourceLocation } | ErrorResponse
```
...
```typespec
op Azure.Core.ResourceOperations.ResourceUpdate(apiVersion: string, contentType: "application/merge-patch+json", resource: Resource): { statusCode: 200, response: Resource } | ErrorResponse
```
...
```typespec
op Azure.Core.ResourceOperations.ResourceRead(apiVersion: string): Azure.Core.{ response: Resource } | ErrorResponse
```
...
```typespec
op Azure.Core.ResourceOperations.ResourceList(apiVersion: string): Azure.Core.BodyRoot<Azure.Core.Foundations.CustomPage<Resource, Traits>> | ErrorResponse
```
...
```typespec
op Azure.Core.ResourceOperations.ResourceAction(apiVersion: string): Azure.Core.{ response: Response } | ErrorResponse
```
...
```typespec
op Azure.Core.ResourceOperations.ResourceCollectionAction(apiVersion: string): Azure.Core.{ response: Response } | ErrorResponse
```
...
```typespec
op Azure.Core.ResourceOperations.LongRunningResourceAction(apiVersion: string): Azure.Core.{ statusCode: 202, response: Azure.Core.ResourceOperationStatus<Resource, StatusResult, StatusError>, operationLocation: TypeSpec.Rest.ResourceLocation } | ErrorResponse
```
...
```typespec
op Azure.Core.ResourceOperations.LongRunningResourceCollectionAction(apiVersion: string): Azure.Core.{ statusCode: 202, response: Azure.Core.ResourceOperationStatus<Resource, StatusResult, StatusError>, operationLocation: TypeSpec.Rest.ResourceLocation } | ErrorResponse
```
...
```typespec
op Azure.Core.ResourceOperations.GetResourceOperationStatus(apiVersion: string): Azure.Core.BodyRoot<Azure.Core.ResourceOperationStatus<Resource, StatusResult, StatusError>> | ErrorResponse
```
...
```typespec
op Azure.Core.GetResourceOperationStatus(apiVersion: string): Azure.Core.BodyRoot<Azure.Core.ResourceOperationStatus<Resource, StatusResult, StatusError>> | Azure.Core.Foundations.ErrorResponse
```
...
```typespec
op Azure.Core.LongRunningResourceAction(apiVersion: string): Azure.Core.{ statusCode: 202, response: Azure.Core.ResourceOperationStatus<Resource, StatusResult, StatusError>, operationLocation: TypeSpec.Rest.ResourceLocation } | Azure.Core.Foundations.ErrorResponse
```
...
```typespec
op Azure.Core.LongRunningResourceCollectionAction(apiVersion: string): Azure.Core.{ statusCode: 202, response: Azure.Core.ResourceOperationStatus<Resource, StatusResult, StatusError>, operationLocation: TypeSpec.Rest.ResourceLocation } | Azure.Core.Foundations.ErrorResponse
```
...
```typespec
op Azure.Core.LongRunningResourceCreateOrReplace(apiVersion: string, resource: Resource): { statusCode: 201, response: Resource, operationLocation: TypeSpec.Rest.ResourceLocation } | { statusCode: 200, response: Resource, operationLocation: TypeSpec.Rest.ResourceLocation } | Azure.Core.Foundations.ErrorResponse
```
...
```typespec
op Azure.Core.LongRunningResourceCreateOrUpdate(apiVersion: string, contentType: "application/merge-patch+json", resource: Resource): { statusCode: 201, response: Resource, operationLocation: TypeSpec.Rest.ResourceLocation } | { statusCode: 200, response: Resource, operationLocation: TypeSpec.Rest.ResourceLocation } | Azure.Core.Foundations.ErrorResponse
```
...
```typespec
op Azure.Core.LongRunningRpcOperation(apiVersion: string): Azure.Core.{ statusCode: 202, response: Azure.Core.ResourceOperationStatus<Resource, StatusResult, StatusError>, operationLocation: TypeSpec.Rest.ResourceLocation } | ErrorResponse
```
...
```typespec
op Azure.Core.ResourceAction(apiVersion: string): Azure.Core.{ response: Response } | Azure.Core.Foundations.ErrorResponse
```
...
```typespec
op Azure.Core.ResourceCollectionAction(apiVersion: string): Azure.Core.{ response: Response } | Azure.Core.Foundations.ErrorResponse
```
...
```typespec
op Azure.Core.ResourceCreateOrReplace(apiVersion: string, resource: Resource): { statusCode: 201, response: Resource } | { statusCode: 200, response: Resource } | Azure.Core.Foundations.ErrorResponse
```
...
```typespec
op Azure.Core.ResourceCreateOrUpdate(apiVersion: string, contentType: "application/merge-patch+json", resource: Resource): { statusCode: 201, response: Resource } | { statusCode: 200, response: Resource } | Azure.Core.Foundations.ErrorResponse
```
...
```typespec
op Azure.Core.ResourceList(apiVersion: string): Azure.Core.BodyRoot<Azure.Core.Foundations.CustomPage<Resource, Traits>> | Azure.Core.Foundations.ErrorResponse
```
...
```typespec
op Azure.Core.ResourceRead(apiVersion: string): Azure.Core.{ response: Resource } | Azure.Core.Foundations.ErrorResponse
```
...
```typespec
op Azure.Core.ResourceUpdate(apiVersion: string, contentType: "application/merge-patch+json", resource: Resource): { statusCode: 200, response: Resource } | Azure.Core.Foundations.ErrorResponse
```
...
```typespec
op Azure.Core.RpcOperation(apiVersion: string): Azure.Core.{ response: Response } | ErrorResponse
```
...
```typespec
op Azure.Core.Foundations.LongRunningOperation(apiVersion: string): Azure.Core.Foundations.{ response: Response, operationLocation: TypeSpec.Rest.ResourceLocation } | ErrorResponse
```
