...
### `@overrideClientMethod` {#@Azure.ClientGenerator.Core.overrideClientMethod}

Override the default client method generated by TCGC from your service definition

```typespec
@Azure.ClientGenerator.Core.overrideClientMethod(override: Operation, scope?: valueof string)
```
