...
| [`@azure-tools/typespec-azure-resource-manager/arm-resource-provisioning-state`](/libraries/azure-resource-manager/rules/arm-resource-provisioning-state.md)     | Check for properly configured provisioningState property.                          |
