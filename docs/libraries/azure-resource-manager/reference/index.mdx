...
- [`ArmTagsProperty`](./data-types.md#Azure.ResourceManager.CommonTypes.ArmTagsProperty)
...
- [`EncryptionConfiguration`](./data-types.md#Azure.ResourceManager.CommonTypes.EncryptionConfiguration)
