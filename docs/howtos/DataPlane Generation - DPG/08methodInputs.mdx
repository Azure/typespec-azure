...
```csharp
//protocol method
public virtual async Task<Response> SetBlobPropertiesAsync(string name, string contentLength, string contentTypes, RequestContext context = null)
public virtual Response SetBlobProperties(string name, string contentLength, string contentTypes, RequestContext context = null)
```
...
```java
public void setBlobProperties(String name, String contentLength, String contentType);
```
