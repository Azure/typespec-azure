...
Python will do dynamic flattening, exposing the non-flattening syntax, and dynamically accepting the flattnedd access.
...
print(f.properties.name)  # Non-flattened access is prefered experience
