...
```ts
function serializeInitialization<
  TServiceOperation extends PythonSdkServiceOperation
>(
  sdkContext: PythonSdkContext<TServiceOperation>,
...
```ts
function serializeServiceMethod<
  TServiceOperation extends PythonSdkServiceOperation
>(
...
>(
  ...
  return {
    ...method,
    name: camelToSnakeCase(method.name),
    initialOperation: serializeServiceOperation(context, method),
  },
}
```
...
>(
  ...
  return {
    ...
    name: camelToSnakeCase(method.name),
    operation: serializeServiceOperation(context, method, method.operation),
    initialOperation: serializeServiceOperation(context, method, method.operation),
    nextLinkOperation: method.nextLinkOperation ? serializeServiceOperation(context, method, method.nextLinkOperation) : undefined,
  },
}
```
...
>(
  ...
  return {
    ...
    name: camelToSnakeCase(method.name),
    operation: serializeServiceOperation(context, method, method.operation),
    initialOperation: serializeServiceOperation(context, method, method.initialOperation),
    nextLinkOperation: method.nextLinkOperation ? serializeServiceOperation(context, method, method.nextLinkOperation) : undefined,
  },
}
...
function serializeHttpServiceOperation(
  context: PythonSdkContext<PythonSdkHttpOperation>,
  method: SdkServiceMethod<PythonSdkHttpOperation>,
  operation: SdkHttpOperation,
): PythonSdkHttpOperation {
  return {
    ...operation,
    parameters: operation.parameters.map(
      (x) => serializeHttpParameter(x)
    ),
    bodyParam: serializeHttpParameter(operation.bodyParam),
  ...
  function serializeHttpParameter<
    THttpParameter extends SdkHttpParameter
  >(
    context: PythonSdkContext<SdkHttpOperation>,
    param: THttpParameter | undefined
  ): THttpParameter | undefined {
    if (!param) return undefined;
    return {
      ...param,
      name: camelToSnakeCase(name.nameInClient),
      type: getPythonSdkType(context, param.type),
    }
  }
...
```ts
import { SdkServiceOperation, SdkType, SdkModelType } from "@azure-tools/typespec-client-generator-core";
import { PythonSdkContext } from "./lib.js";
