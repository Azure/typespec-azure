 ...
 *
 * NOTE: This is a copy of `core/eng/common/scripts/check-lockfile.ts`. It cannot reuse the
 * core script directly because that one resolves the lockfile relative to the core repo root.
 */
