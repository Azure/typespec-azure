...
> **Repository move (2026-06):** Starting from the next release after `0.14.2`, `@azure-tools/typespec-go` is developed in [`Azure/typespec-azure`](https://github.com/Azure/typespec-azure/tree/main/packages/typespec-go). Changelog entries below 0.14.2 were authored in `Azure/autorest.go`; future entries are generated by [chronus](https://github.com/microsoft/chronus) from `.chronus/changes/*.md` at the typespec-azure repo root.
