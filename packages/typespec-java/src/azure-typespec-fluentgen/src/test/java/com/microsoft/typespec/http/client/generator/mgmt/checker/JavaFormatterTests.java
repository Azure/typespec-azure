...
public class JavaFormatterTests {
    ...
    private final String JAVA_CONTENT = "package com.azure.typespec.fluent.checker;\n" +
            "\n" +
            "import com.azure.typespec.extension.base.plugin.PluginLogger;\n" +
            "import com.azure.typespec.fluent.FluentGen;\n" +
...
//        Assertions.assertTrue(Arrays.stream(lines).noneMatch(s -> s.equals("import com.azure.typespec.extension.base.plugin.PluginLogger;")));
//    }
}
