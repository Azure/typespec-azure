...
| [`@azure-tools/typespec-azure-core/use-date-api-version`](https://azure.github.io/typespec-azure/docs/libraries/azure-core/rules/use-date-api-version)                                       | Service API versions must use YYYY-MM-DD date format with an optional -preview suffix.                                                               |
