...
| [`@azure-tools/typespec-azure-core/no-union-expr`](https://azure.github.io/typespec-azure/docs/libraries/azure-core/rules/no-union-expr)                                 | Azure services should not define union expression but create a declaration.                                                                          |
