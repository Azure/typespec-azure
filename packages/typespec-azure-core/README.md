...
| [`@azure-tools/typespec-azure-core/no-unnamed-response-bodies`](https://azure.github.io/typespec-azure/docs/libraries/azure-core/rules/no-unnamed-response-bodies)                           | Operation response bodies should use named models instead of anonymous inline model expressions.                                                     |
