...
| [`@azure-tools/typespec-azure-core/no-version-in-route`](https://azure.github.io/typespec-azure/docs/libraries/azure-core/rules/no-version-in-route)                                         | Do not include an API version segment in operation routes.                                                                                           |
| [`@azure-tools/typespec-azure-core/api-version-date-format`](https://azure.github.io/typespec-azure/docs/libraries/azure-core/rules/api-version-date-format)                                 | Service API versions must use YYYY-MM-DD date format with an optional -preview suffix.                                                               |
