...
const enabledRules = {
  ...
  [`tsp-lintdiff-local-linter/${latestVersionOfCommonTypesMustBeUsedRule.name}`]: true,
  ...
  [`tsp-lintdiff-local-linter/${summaryAndDescriptionMustNotBeSameRule.name}`]: true,
  [`tsp-lintdiff-local-linter/${subscriptionsAndResourceGroupCasingRule.name}`]: true,
  [`tsp-lintdiff-local-linter/${tagsAreNotAllowedForProxyResourcesRule.name}`]: true,
  ...
  [`tsp-lintdiff-local-linter/${noUnsafePatchBodyPropertiesRule.name}`]: true,
  [`tsp-lintdiff-local-linter/${patchPropertiesCorrespondToPutPropertiesRule.name}`]: true,
