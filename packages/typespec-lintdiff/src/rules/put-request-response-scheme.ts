...
export const putRequestResponseSchemeRule = createRule({
  name: "put-request-response-scheme",
  description:
    "Data-plane PUT request body schemas must match the 200 response schema, or the 201 response schema when no 200 response exists.",
  severity: "warning",
  messages: {
    default:
