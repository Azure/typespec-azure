...
rules should resolve to *already covered / template-enforced / blocked*, not new code. The generic
...
- Classifies each rule into: *already covered · template-enforced · blocked/suppression-dependent ·
  partial · true gap · test-quality issue*.
...
- Classification is the point: expect most validator rules to end up *covered / template-enforced /
  blocked*, not new code.
