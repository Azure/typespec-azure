...
See `migration.md` for the latest full-corpus comparison, including the documented TypeSpec-only
SDK-scoped operation that is outside the retained Swagger population.
