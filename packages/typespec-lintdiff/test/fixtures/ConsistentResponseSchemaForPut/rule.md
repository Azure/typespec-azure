...
The fifteen tests in `test/rules/consistent-response-schema-for-put.test.ts`
...
See [migration.md](./migration.md) for the repair evidence and the explicitly
historical (not rerun) corpus comparison.
