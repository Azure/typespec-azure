...
| Local lintdiff coverage    | `packages/typespec-lintdiff/specs/coverage-breakdown.md`, specs commit `f6b53f105b95da05276530a0754a1c71b4f16397`, generated `2026-09-11T10:38:48.729Z`, full scope 462/468 successful projects                                                           |
| Validator source           | `packages/typespec-lintdiff/test/azure-openapi-validator` at `1198225afecbb818c3050d4d2a91da92e14e56ce`; rule registration `packages/rulesets/src/spectral/az-arm.ts`; function `packages/rulesets/src/spectral/functions/put-request-response-scheme.ts` |
...
| `coverage-breakdown.md` before this fix | `Partial observed coverage` |                 36 |                      42 | mapping present, not credited |         34 |              2 |             8 | 160 validator / 184 TypeSpec  |
| `coverage-breakdown.md` after this fix  | `Partial observed coverage` |                 36 |                      34 | mapping present, not credited |         34 |              2 |             0 | 160 validator / 153 TypeSpec  |
