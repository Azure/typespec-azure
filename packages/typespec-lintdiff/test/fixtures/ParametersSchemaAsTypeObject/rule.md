...
| `encoded-model-property-body` | false     | Validator resolution follows scalar, union, and friendly-named template `$ref` schemas; an inline untyped replacement removes `schema.type`                                                                                                    |
