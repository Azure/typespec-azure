...
| [`@azure-tools/typespec-azure-resource-manager/consistent-patch-properties`](https://azure.github.io/typespec-azure/docs/libraries/azure-resource-manager/rules/consistent-patch-properties)                             | ARM PATCH body properties must exist in the resource model at the same nesting level.                                                                                                                                                                 |
