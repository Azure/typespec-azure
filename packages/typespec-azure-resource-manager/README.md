...
| [`@azure-tools/typespec-azure-resource-manager/collection-get-invalid-query-parameter`](https://azure.github.io/typespec-azure/docs/libraries/azure-resource-manager/rules/collection-get-invalid-query-parameter)       | ARM collection GET operations must not declare query parameters beyond api-version and $filter.                                                                                                                                                       |
