...
| [`@azure-tools/typespec-azure-resource-manager/no-repeated-path-info`](https://azure.github.io/typespec-azure/docs/libraries/azure-resource-manager/rules/no-repeated-path-info)                                         | ARM PUT request bodies must not repeat path or query parameters in the resource properties bag.                                                                                                                                                       |
