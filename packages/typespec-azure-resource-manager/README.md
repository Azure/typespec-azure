...
| [`@azure-tools/typespec-azure-resource-manager/collection-response-only-value-and-next-link`](https://azure.github.io/typespec-azure/docs/libraries/azure-resource-manager/rules/collection-response-only-value-and-next-link) | ARM collection GET response models must declare only the `value` and `nextLink` properties.                                                                                                                                                           |
