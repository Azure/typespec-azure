...
| [`@azure-tools/typespec-azure-resource-manager/use-standard-lro-error`](https://azure.github.io/typespec-azure/docs/libraries/azure-resource-manager/rules/use-standard-lro-error)                                       | Long-running operations must define an error response and use ErrorResponse from ARM common types for error payloads.                                                                                                                                 |
