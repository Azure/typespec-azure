...
| [`@azure-tools/typespec-azure-resource-manager/use-required-operations`](https://azure.github.io/typespec-azure/docs/libraries/azure-resource-manager/rules/use-required-operations)                                     | ARM resources must define their required operations: tracked resources need the full lifecycle and list set, other resources need a read operation.                                                                                                   |
