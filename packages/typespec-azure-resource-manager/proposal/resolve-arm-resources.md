...
| `parent`               | A reference to the parent resource when this resource is a child resource. The parent should be resolved from the path after the full resource set is known.                                                       |
