...
enum Features {
  @Azure.ResourceManager.featureOptions(#{featureName: "FeatureA", fileName: "feature-a", description: "The data for feature A"})
  FeatureA: "Feature A",
  @Azure.ResourceManager.featureOptions(#{featureName: "FeatureB", fileName: "feature-b", description: "The data for feature B"})
  FeatureB: "Feature B",

  @Azure.ResourceManager.featureOptions(#{featureName: "Common", fileName: "common", description: "The data in common for all features", title: "Common types for FeatureA and FeatureB", termsOfService: "MIT License"})
  Common: "Common",
}
      @Azure.ResourceManager.feature(Features.FeatureA)
      model ${t.model("FooResource")} is TrackedResource<FooResourceProperties> {
