...
import { pointOperationInvalidQueryParameterRule } from "../../src/rules/point-operation-invalid-query-parameter.js";
...
it("emits for extra query parameters on top-level GET, PUT, PATCH, and DELETE operations", async () => {
  await tester
    ...
    .toEmitDiagnostics([
      {
        code: "@azure-tools/typespec-azure-resource-manager/point-operation-invalid-query-parameter",
        message:
