...
Scenarios.Azure_Core_Lro_Custom_LroStatus_upload = passOnSuccess([
  {
    uri: "/azure/core/lro/custom/lro-status/securitydomain/upload",
    method: "post",
    request: {
  ...
  {
    uri: "/azure/core/lro/custom/lro-status/securitydomain/upload/pending",
    method: "get",
    request: {
      query: {
        "api-version": "2022-12-01-preview",
...
Scenarios.Azure_Core_Lro_Custom_LroStatus_uploadPending = passOnSuccess([
  {
    uri: "/azure/core/lro/custom/lro-status/securitydomain/upload/pending",
    method: "get",
    request: {
