...
import TypeEnumFixedClientFactory, { FixedClient } from "./generated/type/enum/fixed/src/index.js";
describe("FixedEnums Rest Client", () => {
  ...
  it("should put unknown value and receives 500", async () => {
    const result = await client.path("/type/enum/fixed/string/unknown-value").put({
      body: "Weekend" as any,
      contentType: "application/json",
    });
