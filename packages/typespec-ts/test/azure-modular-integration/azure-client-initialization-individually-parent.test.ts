...
describe("Azure ClientGeneratorCore IndividuallyParent Client Initialization", () => {
  ...
  describe("IndividuallyParentNestedWithPathClient", () => {
    ...
    beforeEach(() => {
      client = new IndividuallyParentNestedWithPathClient("test-blob", endpointOptions);
    });
  ...
  describe("IndividuallyParentNestedWithParamAliasClient", () => {
    ...
    beforeEach(() => {
      client = new IndividuallyParentNestedWithParamAliasClient("sample-blob", endpointOptions);
    });
