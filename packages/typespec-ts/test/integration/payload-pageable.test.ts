...
import PageableClientFactory, { PageableClient } from "./generated/payload/pageable/src/index.js";
...
describe("Pageable Client", () => {
  ...
  it.skip("should get pageable Server Driven Pagination link", async () => {
    const result = await client.path("/payload/pageable/server-driven-pagination/link").get();
