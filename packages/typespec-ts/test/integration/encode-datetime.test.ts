...
describe("EncodeDatetimeClient Rest Client", () => {
  ...
  describe("query", () => {
    ...
    it(`should get unix-timestamp query`, async () => {
      const result = await client.path(`/encode/datetime/query/unix-timestamp`).get({
        queryParameters: {
          value: 1686566864,
        },
    ...
    it(`should get unix-timestamp-array query`, async () => {
      const result = await client.path(`/encode/datetime/query/unix-timestamp-array`).get({
        queryParameters: {
  ...
  describe("property", () => {
    it(`should post default property`, async () => {
      const result = await client.path(`/encode/datetime/property/default`).post({
        body: {
          value: "2022-08-26T18:38:00.000Z",
        },
      });
    ...
    it(`should post rfc3339 property`, async () => {
      const result = await client.path(`/encode/datetime/property/rfc3339`).post({
        body: {
          value: "2022-08-26T18:38:00.000Z",
        },
      });
    ...
    it(`should post rfc7231 property`, async () => {
      const result = await client.path(`/encode/datetime/property/rfc7231`).post({
        body: {
          value: "Fri, 26 Aug 2022 14:38:00 GMT",
        },
      });
    ...
    it(`should post unix-timestamp property`, async () => {
      const result = await client.path(`/encode/datetime/property/unix-timestamp`).post({
        body: {
          value: 1686566864,
        },
      });
    ...
    it(`should post unix-timestamp-array property`, async () => {
      const result = await client.path(`/encode/datetime/property/unix-timestamp-array`).post({
        body: {
          value: [1686566864, 1686734256],
        },
      });
  ...
  describe("header", () => {
    ...
    it(`should get unix-timestamp header`, async () => {
      const result = await client.path(`/encode/datetime/header/unix-timestamp`).get({
        headers: {
          value: 1686566864,
        },
      });
    ...
    it(`should get unix-timestamp-array header`, async () => {
      const result = await client.path(`/encode/datetime/header/unix-timestamp-array`).get({
        headers: {
  ...
  describe("response header", () => {
    it(`should get default header`, async () => {
      const result = await client.path(`/encode/datetime/responseheader/default`).get();
      assert.strictEqual(result.status, "204");
      assert.strictEqual(result.headers.value, "Fri, 26 Aug 2022 14:38:00 GMT");
    });

    it(`should get rfc3339 header`, async () => {
      const result = await client.path(`/encode/datetime/responseheader/rfc3339`).get();
      assert.strictEqual(result.status, "204");
      assert.strictEqual(result.headers.value, "2022-08-26T18:38:00.000Z");
    });

    it(`should get rfc7231 header`, async () => {
      const result = await client.path(`/encode/datetime/responseheader/rfc7231`).get();
      assert.strictEqual(result.status, "204");
      assert.strictEqual(result.headers.value, "Fri, 26 Aug 2022 14:38:00 GMT");
    });
    ...
    it.skip(`should get unix-timestamp header`, async () => {
      const result = await client.path(`/encode/datetime/responseheader/unix-timestamp`).get();
      assert.strictEqual(result.status, "204");
