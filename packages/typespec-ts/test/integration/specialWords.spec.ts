...
describe("SpecialWordsClient Rest Client", () => {
  ...
  describe("operations", () => {
    ...
    it("should get special words for operation `assert`", async () => {
      const result = await client.path("/special-words/operations/assert").get();
      assert.strictEqual(result.status, "204");
    });
    ...
    it("should get special words for operation `constructor`", async () => {
      const result = await client.path("/special-words/operations/constructor").get();
      assert.strictEqual(result.status, "204");
    });
    it("should get special words for operation `continue`", async () => {
      const result = await client.path("/special-words/operations/continue").get();
      assert.strictEqual(result.status, "204");
    });
    ...
    it("should get special words for operation `except`", async () => {
      const result = await client.path("/special-words/operations/except").get();
      assert.strictEqual(result.status, "204");
    });
    ...
    it("should get special words for operation `finally`", async () => {
      const result = await client.path("/special-words/operations/finally").get();
      assert.strictEqual(result.status, "204");
    });
    ...
    it("should get special words for operation `global`", async () => {
      const result = await client.path("/special-words/operations/global").get();
      assert.strictEqual(result.status, "204");
    });
    ...
    it("should get special words for operation `import`", async () => {
      const result = await client.path("/special-words/operations/import").get();
      assert.strictEqual(result.status, "204");
    });
    ...
    it("should get special words for operation `lambda`", async () => {
      const result = await client.path("/special-words/operations/lambda").get();
      assert.strictEqual(result.status, "204");
    });
    ...
    it("should get special words for operation `return`", async () => {
      const result = await client.path("/special-words/operations/return").get();
      assert.strictEqual(result.status, "204");
    });
  ...
  describe("parameters", () => {
    ...
    it("should get special words for operation `constructor`", async () => {
      const result = await client.path("/special-words/parameters/constructor").get({
        queryParameters: {
    ...
    it("should get special words for operation `continue`", async () => {
      const result = await client.path("/special-words/parameters/continue").get({
        queryParameters: {
          continue: "ok",
        },
      });
    ...
    it("should get special words for operation `finally`", async () => {
      const result = await client.path("/special-words/parameters/finally").get({
        queryParameters: {
          finally: "ok",
        },
      });
    ...
    it("should get special words for operation `cancellationToken`", async () => {
      const result = await client.path("/special-words/parameters/cancellationToken").get({
        queryParameters: {
  ...
  describe("models", () => {
    ...
    it("should get special words for operation `constructor`", async () => {
      const result = await client.path("/special-words/models/constructor").post({
        body: {
          name: "ok",
        },
      });
  ...
  describe("model properties", () => {
    it("should post special words for operation `same-as-model`", async () => {
      const result = await client.path("/special-words/model-properties/same-as-model").post({
        body: {
          SameAsModel: "ok",
        },
      });
