...
describe("EncodeDatetimeClient Rest Client", () => {
  ...
  describe("query", () => {
    it(`should get default datetime`, async () => {
      const result = await client.query.default(new Date("2022-08-26T18:38:00.000Z"));
      assert.isUndefined(result);
    });

    it(`should get rfc3339`, async () => {
      const result = await client.query.rfc3339(new Date("2022-08-26T18:38:00.000Z"));
      assert.isUndefined(result);
    });

    it(`should get rfc7231`, async () => {
      const result = await client.query.rfc7231(new Date("Fri, 26 Aug 2022 14:38:00 GMT"));
      assert.isUndefined(result);
    });
  ...
  describe("header", () => {
    it(`should get default datetime`, async () => {
      const result = await client.header.default(new Date("Fri, 26 Aug 2022 14:38:00 GMT"));
      assert.isUndefined(result);
    });

    it(`should get rfc3339`, async () => {
      const result = await client.header.rfc3339(new Date("2022-08-26T18:38:00.000Z"));
      assert.isUndefined(result);
    });

    it(`should get rfc7231`, async () => {
      const result = await client.header.rfc7231(new Date("Fri, 26 Aug 2022 14:38:00 GMT"));
      assert.isUndefined(result);
    });
  ...
  describe("response header", () => {
    it(`should get default header`, async () => {
      const result = await client.responseHeader.default({
        onResponse: (res) => {
          assert.strictEqual(res.headers.get("value"), "Fri, 26 Aug 2022 14:38:00 GMT");
        },
      });
      assert.isUndefined(result);
    });
    ...
    it(`should get rfc3339 header`, async () => {
      const result = await client.responseHeader.rfc3339({
        onResponse: (res) => {
          assert.strictEqual(res.headers.get("value"), "2022-08-26T18:38:00.000Z");
        },
      });
      assert.isUndefined(result);
    });
