...
export declare interface ExtendsUnknownAdditionalPropertiesDiscriminated extends Record<
  string,
  any
> {
  name: string;
...
export declare type ExtendsUnknownAdditionalPropertiesDiscriminatedUnion =
...
export declare type IsUnknownAdditionalPropertiesDiscriminatedUnion =
