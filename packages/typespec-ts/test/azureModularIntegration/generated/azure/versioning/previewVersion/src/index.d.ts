...
export declare class PreviewVersionClient {
  ...
  updateWidgetColor(
    id: string,
    colorUpdate: UpdateWidgetColorRequest,
    options?: UpdateWidgetColorOptionalParams,
  ): Promise<Widget | undefined>;
  getWidget(id: string, options?: GetWidgetOptionalParams): Promise<Widget | undefined>;
}
