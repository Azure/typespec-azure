...
export declare interface CheckNameAvailabilityOperations {
  checkLocal: (
    ...
    options?: CheckNameAvailabilityCheckLocalOptionalParams,
  ) => Promise<CheckNameAvailabilityResponse>;
  checkGlobal: (
    body: CheckNameAvailabilityRequest,
    options?: CheckNameAvailabilityCheckGlobalOptionalParams,
  ) => Promise<CheckNameAvailabilityResponse>;
}
...
export declare interface LroOperations {
  exportArray: (
    body: ExportRequest,
    options?: LroExportArrayOptionalParams,
  ) => PollerLike<OperationState<ExportResult[]>, ExportResult[]>;
  delete: (
    resourceGroupName: string,
    orderName: string,
    options?: LroDeleteOptionalParams,
  ) => PollerLike<OperationState<void>, void>;
  export: (
    resourceGroupName: string,
    orderName: string,
    body: ExportRequest,
    options?: LroExportOptionalParams,
  ) => PollerLike<OperationState<ExportResult>, ExportResult>;
  createOrReplace: (
    resourceGroupName: string,
    orderName: string,
    resource: Order,
    options?: LroCreateOrReplaceOptionalParams,
...
export declare interface LroPagingOperations {
  postPagingLro: (
    resourceGroupName: string,
    productName: string,
    options?: LroPagingPostPagingLroOptionalParams,
...
export declare interface OptionalBodyOperations {
  providerPost: (
    options?: OptionalBodyProviderPostOptionalParams,
  ) => Promise<ChangeAllowanceResult>;
  post: (
    resourceGroupName: string,
    widgetName: string,
    options?: OptionalBodyPostOptionalParams,
  ) => Promise<ActionResult>;
  patch: (
    resourceGroupName: string,
    widgetName: string,
    options?: OptionalBodyPatchOptionalParams,
  ) => Promise<Widget>;
  get: (
    resourceGroupName: string,
    widgetName: string,
    options?: OptionalBodyGetOptionalParams,
  ) => Promise<Widget>;
}
...
export declare function restorePoller<TResponse extends PathUncheckedResponse, TResult>(
  client: OperationTemplatesClient,
