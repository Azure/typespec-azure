...
export declare class CommonPropertiesClient {
  ...
  createForUserDefinedError(
    resourceGroupName: string,
    confidentialResourceName: string,
    resource: ConfidentialResource,
    options?: CreateForUserDefinedErrorOptionalParams,
  ): Promise<ConfidentialResource>;
  getForPredefinedError(
    resourceGroupName: string,
    confidentialResourceName: string,
    options?: GetForPredefinedErrorOptionalParams,
  ): Promise<ConfidentialResource>;
  ...
  createWithSystemAssigned(
    ...
    options?: CreateWithSystemAssignedOptionalParams,
  ): Promise<ManagedIdentityTrackedResource>;
  get(
    resourceGroupName: string,
    managedIdentityTrackedResourceName: string,
