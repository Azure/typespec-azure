...
export declare interface ExtensionsResourcesOperations {
  listByScope: (
    resourceUri: string,
    options?: ExtensionsResourcesListByScopeOptionalParams,
  ) => PagedAsyncIterableIterator<ExtensionsResource>;
  delete: (
    resourceUri: string,
    extensionsResourceName: string,
    options?: ExtensionsResourcesDeleteOptionalParams,
  ) => Promise<void>;
  update: (
    resourceUri: string,
    extensionsResourceName: string,
    properties: ExtensionsResource,
    options?: ExtensionsResourcesUpdateOptionalParams,
  ) => Promise<ExtensionsResource>;
  createOrUpdate: (
    resourceUri: string,
    extensionsResourceName: string,
    resource: ExtensionsResource,
    options?: ExtensionsResourcesCreateOrUpdateOptionalParams,
  ) => PollerLike<OperationState<ExtensionsResource>, ExtensionsResource>;
  get: (
    resourceUri: string,
    extensionsResourceName: string,
    options?: ExtensionsResourcesGetOptionalParams,
  ) => Promise<ExtensionsResource>;
}
...
export declare interface LocationResourcesOperations {
  listByLocation: (
    location: string,
    options?: LocationResourcesListByLocationOptionalParams,
  ) => PagedAsyncIterableIterator<LocationResource>;
  delete: (
    location: string,
    locationResourceName: string,
    options?: LocationResourcesDeleteOptionalParams,
  ) => Promise<void>;
  update: (
    location: string,
    locationResourceName: string,
    properties: LocationResource,
    options?: LocationResourcesUpdateOptionalParams,
  ) => Promise<LocationResource>;
  createOrUpdate: (
    location: string,
    locationResourceName: string,
    resource: LocationResource,
    options?: LocationResourcesCreateOrUpdateOptionalParams,
  ) => Promise<LocationResource>;
  get: (
    location: string,
    locationResourceName: string,
    options?: LocationResourcesGetOptionalParams,
  ) => Promise<LocationResource>;
}
...
export declare interface NestedOperations {
  listByTopLevelTrackedResource: (
    ...
    options?: NestedListByTopLevelTrackedResourceOptionalParams,
  ) => PagedAsyncIterableIterator<NestedProxyResource>;
  delete: (
    resourceGroupName: string,
    topLevelTrackedResourceName: string,
    nextedProxyResourceName: string,
    options?: NestedDeleteOptionalParams,
  ...
  update: (
    ...
    options?: NestedUpdateOptionalParams,
  ...
  createOrReplace: (
    ...
    options?: NestedCreateOrReplaceOptionalParams,
  ) => PollerLike<OperationState<NestedProxyResource>, NestedProxyResource>;
  get: (
    resourceGroupName: string,
    topLevelTrackedResourceName: string,
    nextedProxyResourceName: string,
    options?: NestedGetOptionalParams,
...
export declare interface SingletonOperations {
  listByResourceGroup: (
    resourceGroupName: string,
    options?: SingletonListByResourceGroupOptionalParams,
  ) => PagedAsyncIterableIterator<SingletonTrackedResource>;
  update: (
    resourceGroupName: string,
    properties: SingletonTrackedResource,
    options?: SingletonUpdateOptionalParams,
  ) => Promise<SingletonTrackedResource>;
  createOrUpdate: (
    resourceGroupName: string,
    resource: SingletonTrackedResource,
    options?: SingletonCreateOrUpdateOptionalParams,
  ) => PollerLike<OperationState<SingletonTrackedResource>, SingletonTrackedResource>;
  getByResourceGroup: (
    resourceGroupName: string,
    options?: SingletonGetByResourceGroupOptionalParams,
  ) => Promise<SingletonTrackedResource>;
}
...
export declare interface TopLevelOperations {
  actionSync: (
    ...
    options?: TopLevelActionSyncOptionalParams,
  ) => Promise<void>;
  listBySubscription: (
    options?: TopLevelListBySubscriptionOptionalParams,
  ) => PagedAsyncIterableIterator<TopLevelTrackedResource>;
  listByResourceGroup: (
    resourceGroupName: string,
    options?: TopLevelListByResourceGroupOptionalParams,
  ) => PagedAsyncIterableIterator<TopLevelTrackedResource>;
  delete: (
    resourceGroupName: string,
    topLevelTrackedResourceName: string,
    options?: TopLevelDeleteOptionalParams,
  ) => PollerLike<OperationState<void>, void>;
  update: (
    resourceGroupName: string,
    topLevelTrackedResourceName: string,
    properties: TopLevelTrackedResource,
    options?: TopLevelUpdateOptionalParams,
  ) => PollerLike<OperationState<TopLevelTrackedResource>, TopLevelTrackedResource>;
  createOrReplace: (
    resourceGroupName: string,
    topLevelTrackedResourceName: string,
    resource: TopLevelTrackedResource,
    options?: TopLevelCreateOrReplaceOptionalParams,
  ) => PollerLike<OperationState<TopLevelTrackedResource>, TopLevelTrackedResource>;
  get: (
    resourceGroupName: string,
    topLevelTrackedResourceName: string,
    options?: TopLevelGetOptionalParams,
