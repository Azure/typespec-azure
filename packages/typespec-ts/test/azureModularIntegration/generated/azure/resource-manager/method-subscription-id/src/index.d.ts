...
export declare interface ResourceGroupResourceOperationsOperations {
  delete: (
    ...
    options?: ResourceGroupResourceOperationsDeleteOptionalParams,
  ) => Promise<void>;
  put: (
    resourceGroupName: string,
    resourceGroupResourceName: string,
    resource: ResourceGroupResource,
    options?: ResourceGroupResourceOperationsPutOptionalParams,
  ) => Promise<ResourceGroupResource>;
  get: (
    resourceGroupName: string,
    resourceGroupResourceName: string,
    options?: ResourceGroupResourceOperationsGetOptionalParams,
  ) => Promise<ResourceGroupResource>;
}
...
export declare interface SubscriptionResource1OperationsOperations {
  delete: (
    ...
    options?: SubscriptionResource1OperationsDeleteOptionalParams,
  ) => Promise<void>;
  put: (
    subscriptionId: string,
    subscriptionResource1Name: string,
    resource: SubscriptionResource1,
    options?: SubscriptionResource1OperationsPutOptionalParams,
  ) => Promise<SubscriptionResource1>;
  get: (
    subscriptionId: string,
    subscriptionResource1Name: string,
    options?: SubscriptionResource1OperationsGetOptionalParams,
  ) => Promise<SubscriptionResource1>;
}
...
export declare interface SubscriptionResource2OperationsOperations {
  delete: (
    ...
    options?: SubscriptionResource2OperationsDeleteOptionalParams,
  ) => Promise<void>;
  put: (
    subscriptionId: string,
    subscriptionResource2Name: string,
    resource: SubscriptionResource2,
    options?: SubscriptionResource2OperationsPutOptionalParams,
  ) => Promise<SubscriptionResource2>;
  get: (
    subscriptionId: string,
    subscriptionResource2Name: string,
    options?: SubscriptionResource2OperationsGetOptionalParams,
  ) => Promise<SubscriptionResource2>;
}
...
export declare interface SubscriptionResourceOperationsOperations {
  delete: (
    ...
    options?: SubscriptionResourceOperationsDeleteOptionalParams,
  ) => Promise<void>;
  put: (
    subscriptionId: string,
    subscriptionResourceName: string,
    resource: SubscriptionResource,
    options?: SubscriptionResourceOperationsPutOptionalParams,
  ) => Promise<SubscriptionResource>;
  get: (
    subscriptionId: string,
    subscriptionResourceName: string,
    options?: SubscriptionResourceOperationsGetOptionalParams,
  ) => Promise<SubscriptionResource>;
}
