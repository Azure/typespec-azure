...
export declare interface GroupParametersOperations {
  group: (
    ...
    optionalParams?: GroupParametersGroupOptionalParams,
  ) => Promise<void>;
}
...
export declare interface RemoveOptionalParameterOperations {
  removeOptional: (
    param1: string,
    options?: RemoveOptionalParameterRemoveOptionalOptionalParams,
  ) => Promise<void>;
}
...
export declare interface ReorderParametersOperations {
  reorder: (
    param1: string,
    param2: string,
    options?: ReorderParametersReorderOptionalParams,
  ) => Promise<void>;
}
...
export declare interface RequireOptionalParameterOperations {
  requireOptional: (
    param1: string,
    param2: string,
    options?: RequireOptionalParameterRequireOptionalOptionalParams,
  ) => Promise<void>;
}
