...
export declare class AccessClient {
  ...
  publicDecoratorInInternal(
    name: string,
    options?: PublicDecoratorInInternalOptionalParams,
  ): Promise<PublicDecoratorModelInInternal>;
  internalDecoratorInInternal(
    name: string,
    options?: InternalDecoratorInInternalOptionalParams,
  ): Promise<InternalDecoratorModelInInternal>;
  noDecoratorInInternal(
    name: string,
    options?: NoDecoratorInInternalOptionalParams,
  ): Promise<NoDecoratorModelInInternal>;
  publicDecoratorInPublic(
    name: string,
    options?: PublicDecoratorInPublicOptionalParams,
  ): Promise<PublicDecoratorModelInPublic>;
  noDecoratorInPublic(
    name: string,
    options?: NoDecoratorInPublicOptionalParams,
