...
export declare class IndividuallyParentClient {
  ...
  getIndividuallyParentNestedWithPathClient(
    blobName: string,
    options?: IndividuallyParentNestedWithPathClientOptionalParams,
  ): IndividuallyParentNestedWithPathClient;
  getIndividuallyParentNestedWithQueryClient(
    blobName: string,
    options?: IndividuallyParentNestedWithQueryClientOptionalParams,
  ): IndividuallyParentNestedWithQueryClient;
  getIndividuallyParentNestedWithHeaderClient(
    name: string,
    options?: IndividuallyParentNestedWithHeaderClientOptionalParams,
  ): IndividuallyParentNestedWithHeaderClient;
  getIndividuallyParentNestedWithMultipleClient(
    name: string,
    region: string,
    options?: IndividuallyParentNestedWithMultipleClientOptionalParams,
  ): IndividuallyParentNestedWithMultipleClient;
  getIndividuallyParentNestedWithMixedClient(
    name: string,
    options?: IndividuallyParentNestedWithMixedClientOptionalParams,
  ): IndividuallyParentNestedWithMixedClient;
  getIndividuallyParentNestedWithParamAliasClient(
    blobName: string,
    options?: IndividuallyParentNestedWithParamAliasClientOptionalParams,
...
export declare class IndividuallyParentNestedWithHeaderClient {
  ...
  deleteStandalone(
    options?: IndividuallyParentNestedWithHeaderClientDeleteStandaloneOptionalParams,
  ): Promise<void>;
  getStandalone(
    options?: IndividuallyParentNestedWithHeaderClientGetStandaloneOptionalParams,
  ): Promise<void>;
  withQuery(
    options?: IndividuallyParentNestedWithHeaderClientWithQueryOptionalParams,
  ): Promise<void>;
}
...
export declare class IndividuallyParentNestedWithMixedClient {
  ...
  deleteStandalone(
    region: string,
    options?: IndividuallyParentNestedWithMixedClientDeleteStandaloneOptionalParams,
  ): Promise<void>;
  getStandalone(
    region: string,
    options?: IndividuallyParentNestedWithMixedClientGetStandaloneOptionalParams,
  ): Promise<void>;
  withQuery(
    region: string,
    options?: IndividuallyParentNestedWithMixedClientWithQueryOptionalParams,
  ): Promise<void>;
}
...
export declare class IndividuallyParentNestedWithMultipleClient {
  ...
  deleteStandalone(
    options?: IndividuallyParentNestedWithMultipleClientDeleteStandaloneOptionalParams,
  ): Promise<void>;
  getStandalone(
    options?: IndividuallyParentNestedWithMultipleClientGetStandaloneOptionalParams,
  ): Promise<void>;
  withQuery(
    options?: IndividuallyParentNestedWithMultipleClientWithQueryOptionalParams,
  ): Promise<void>;
}
...
export declare class IndividuallyParentNestedWithQueryClient {
  ...
  deleteStandalone(
    options?: IndividuallyParentNestedWithQueryClientDeleteStandaloneOptionalParams,
  ): Promise<void>;
  getStandalone(
    options?: IndividuallyParentNestedWithQueryClientGetStandaloneOptionalParams,
  ): Promise<BlobProperties>;
  withQuery(
    options?: IndividuallyParentNestedWithQueryClientWithQueryOptionalParams,
  ): Promise<void>;
}
