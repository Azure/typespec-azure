...
export declare class IndividuallyNestedWithHeaderClient {
  ...
  deleteStandalone(
    options?: IndividuallyNestedWithHeaderClientDeleteStandaloneOptionalParams,
  ): Promise<void>;
  getStandalone(
    options?: IndividuallyNestedWithHeaderClientGetStandaloneOptionalParams,
  ): Promise<void>;
...
export declare class IndividuallyNestedWithMixedClient {
  ...
  deleteStandalone(
    region: string,
    options?: IndividuallyNestedWithMixedClientDeleteStandaloneOptionalParams,
  ): Promise<void>;
  getStandalone(
    region: string,
    options?: IndividuallyNestedWithMixedClientGetStandaloneOptionalParams,
  ): Promise<void>;
  withQuery(
    region: string,
    options?: IndividuallyNestedWithMixedClientWithQueryOptionalParams,
  ): Promise<void>;
}
...
export declare class IndividuallyNestedWithMultipleClient {
  ...
  constructor(
    name: string,
    region: string,
    options?: IndividuallyNestedWithMultipleClientOptionalParams,
  );
  deleteStandalone(
    options?: IndividuallyNestedWithMultipleClientDeleteStandaloneOptionalParams,
  ): Promise<void>;
  getStandalone(
    options?: IndividuallyNestedWithMultipleClientGetStandaloneOptionalParams,
  ): Promise<void>;
...
export declare class IndividuallyNestedWithQueryClient {
  ...
  deleteStandalone(
    options?: IndividuallyNestedWithQueryClientDeleteStandaloneOptionalParams,
  ): Promise<void>;
  getStandalone(
    options?: IndividuallyNestedWithQueryClientGetStandaloneOptionalParams,
