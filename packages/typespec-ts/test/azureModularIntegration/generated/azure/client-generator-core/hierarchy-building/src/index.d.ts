...
export declare interface AnimalOperationsOperations {
  updateDogAsAnimal: (
    animal: AnimalUnion,
    options?: AnimalOperationsUpdateDogAsAnimalOptionalParams,
  ) => Promise<AnimalUnion>;
  updatePetAsAnimal: (
    animal: AnimalUnion,
    options?: AnimalOperationsUpdatePetAsAnimalOptionalParams,
  ) => Promise<AnimalUnion>;
}
...
export declare interface PetOperationsOperations {
  updateDogAsPet: (
    pet: PetUnion,
    options?: PetOperationsUpdateDogAsPetOptionalParams,
  ) => Promise<PetUnion>;
  updatePetAsPet: (
    pet: PetUnion,
    options?: PetOperationsUpdatePetAsPetOptionalParams,
  ) => Promise<PetUnion>;
}
