...
export declare class FlattenPropertyClient {
  ...
  putFlattenReadOnlyModel(
    body: Solution,
    options?: PutFlattenReadOnlyModelOptionalParams,
  ): Promise<Solution>;
  putFlattenUnknownModel(
    input: FlattenUnknownModel,
    options?: PutFlattenUnknownModelOptionalParams,
  ): Promise<FlattenUnknownModel>;
  putNestedFlattenModel(
    input: NestedFlattenModel,
    options?: PutNestedFlattenModelOptionalParams,
  ): Promise<NestedFlattenModel>;
  putFlattenModel(
    input: FlattenModel,
    options?: PutFlattenModelOptionalParams,
