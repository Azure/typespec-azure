...
import EncodeNumericClientFactory, { NumericClient } from "./generated/encode/numeric/src/index.js";
describe("EncodeNumericClient Rest Client", () => {
  ...
  describe("property", () => {
    it(`should post safeint property`, async () => {
      const result = await client.path(`/encode/numeric/property/safeint`).post({
        body: {
          value: "10000000000",
        },
      });
