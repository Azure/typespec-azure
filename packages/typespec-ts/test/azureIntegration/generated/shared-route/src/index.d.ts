...
export declare type ListByResourceGroupParameters = ListByResourceGroupQueryParam &
...
export declare interface ListBySubscription {
  ...
  ): StreamableMethod<ListBySubscription202Response | ListBySubscriptionDefaultResponse>;
  post(
...
export declare type ListBySubscriptionParameters = ListBySubscriptionHeaderParam &
...
export declare type ProcessIntParameters = ProcessIntQueryParam &
  ProcessIntBodyParam &
  RequestParameters;
...
export declare type ProcessStringParameters = ProcessStringQueryParam &
...
export declare type ReturnsIntParameters = ReturnsIntQueryParam &
  ReturnsIntBodyParam &
  RequestParameters;
...
export declare type ReturnsStringParameters = ReturnsStringQueryParam &
...
export declare type UpdateIntParameters = UpdateIntQueryParam &
  UpdateIntBodyParam &
  RequestParameters;
...
export declare type UpdateStringParameters = UpdateStringQueryParam &
