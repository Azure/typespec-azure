...
declare function createClient({
  apiVersion,
  ...options
}?: AzureArmResourceClientOptions): AzureArmResourceClient;
...
export declare type ExtensionsResourcesCreateOrUpdateParameters =
  ExtensionsResourcesCreateOrUpdateBodyParam & RequestParameters;
...
export declare interface ExtensionsResourcesGet {
  get(
    options?: ExtensionsResourcesGetParameters,
  ): StreamableMethod<ExtensionsResourcesGet200Response | ExtensionsResourcesGetDefaultResponse>;
  put(
    options: ExtensionsResourcesCreateOrUpdateParameters,
  ): StreamableMethod<
    | ExtensionsResourcesCreateOrUpdate200Response
    | ExtensionsResourcesCreateOrUpdate201Response
    | ExtensionsResourcesCreateOrUpdateDefaultResponse
  >;
  patch(
    options: ExtensionsResourcesUpdateParameters,
  ): StreamableMethod<
    ExtensionsResourcesUpdate200Response | ExtensionsResourcesUpdateDefaultResponse
  >;
  delete(
    options?: ExtensionsResourcesDeleteParameters,
  ): StreamableMethod<
    | ExtensionsResourcesDelete200Response
    | ExtensionsResourcesDelete204Response
    | ExtensionsResourcesDeleteDefaultResponse
  >;
}
...
export declare interface ExtensionsResourcesListByScope {
  get(
    options?: ExtensionsResourcesListByScopeParameters,
  ): StreamableMethod<
    ExtensionsResourcesListByScope200Response | ExtensionsResourcesListByScopeDefaultResponse
  >;
}
...
export declare type ExtensionsResourcesUpdateParameters = ExtensionsResourcesUpdateBodyParam &
  RequestParameters;
...
export declare function getLongRunningPoller<
  TResult extends TopLevelCreateOrReplaceLogicalResponse | TopLevelCreateOrReplaceDefaultResponse,
>(
  client: Client,
  initialResponse:
    | TopLevelCreateOrReplace200Response
    | TopLevelCreateOrReplace201Response
    | TopLevelCreateOrReplaceDefaultResponse,
  options?: CreateHttpPollerOptions<TResult, OperationState<TResult>>,
): Promise<SimplePollerLike<OperationState<TResult>, TResult>>;

export declare function getLongRunningPoller<
  TResult extends TopLevelUpdateLogicalResponse | TopLevelUpdateDefaultResponse,
>(
  client: Client,
  initialResponse:
    | TopLevelUpdate200Response
    | TopLevelUpdate202Response
    | TopLevelUpdateDefaultResponse,
  options?: CreateHttpPollerOptions<TResult, OperationState<TResult>>,
): Promise<SimplePollerLike<OperationState<TResult>, TResult>>;

export declare function getLongRunningPoller<
  TResult extends TopLevelDeleteLogicalResponse | TopLevelDeleteDefaultResponse,
>(
  client: Client,
  initialResponse:
    | TopLevelDelete202Response
    | TopLevelDelete204Response
    | TopLevelDeleteDefaultResponse,
  options?: CreateHttpPollerOptions<TResult, OperationState<TResult>>,
): Promise<SimplePollerLike<OperationState<TResult>, TResult>>;

export declare function getLongRunningPoller<
  TResult extends NestedCreateOrReplaceLogicalResponse | NestedCreateOrReplaceDefaultResponse,
>(
  client: Client,
  initialResponse:
    | NestedCreateOrReplace200Response
    | NestedCreateOrReplace201Response
    | NestedCreateOrReplaceDefaultResponse,
  options?: CreateHttpPollerOptions<TResult, OperationState<TResult>>,
): Promise<SimplePollerLike<OperationState<TResult>, TResult>>;

export declare function getLongRunningPoller<
  TResult extends NestedUpdateLogicalResponse | NestedUpdateDefaultResponse,
>(
  client: Client,
  initialResponse: NestedUpdate200Response | NestedUpdate202Response | NestedUpdateDefaultResponse,
  options?: CreateHttpPollerOptions<TResult, OperationState<TResult>>,
): Promise<SimplePollerLike<OperationState<TResult>, TResult>>;

export declare function getLongRunningPoller<
  TResult extends NestedDeleteLogicalResponse | NestedDeleteDefaultResponse,
>(
  client: Client,
  initialResponse: NestedDelete202Response | NestedDelete204Response | NestedDeleteDefaultResponse,
  options?: CreateHttpPollerOptions<TResult, OperationState<TResult>>,
): Promise<SimplePollerLike<OperationState<TResult>, TResult>>;

export declare function getLongRunningPoller<
  TResult extends SingletonCreateOrUpdateLogicalResponse | SingletonCreateOrUpdateDefaultResponse,
>(
  client: Client,
  initialResponse:
    | SingletonCreateOrUpdate200Response
    | SingletonCreateOrUpdate201Response
    | SingletonCreateOrUpdateDefaultResponse,
  options?: CreateHttpPollerOptions<TResult, OperationState<TResult>>,
): Promise<SimplePollerLike<OperationState<TResult>, TResult>>;

export declare function getLongRunningPoller<
  TResult extends
    | ExtensionsResourcesCreateOrUpdateLogicalResponse
    | ExtensionsResourcesCreateOrUpdateDefaultResponse,
>(
  client: Client,
  initialResponse:
...
export declare function isUnexpected(
  response: TopLevelGet200Response | TopLevelGetDefaultResponse,
): response is TopLevelGetDefaultResponse;

export declare function isUnexpected(
  response:
    | TopLevelCreateOrReplace200Response
    | TopLevelCreateOrReplace201Response
    | TopLevelCreateOrReplaceLogicalResponse
    | TopLevelCreateOrReplaceDefaultResponse,
): response is TopLevelCreateOrReplaceDefaultResponse;

export declare function isUnexpected(
  response:
    | TopLevelUpdate200Response
    | TopLevelUpdate202Response
    | TopLevelUpdateLogicalResponse
    | TopLevelUpdateDefaultResponse,
): response is TopLevelUpdateDefaultResponse;

export declare function isUnexpected(
  response:
    | TopLevelDelete202Response
    | TopLevelDelete204Response
    | TopLevelDeleteLogicalResponse
    | TopLevelDeleteDefaultResponse,
): response is TopLevelDeleteDefaultResponse;

export declare function isUnexpected(
  response: TopLevelListByResourceGroup200Response | TopLevelListByResourceGroupDefaultResponse,
): response is TopLevelListByResourceGroupDefaultResponse;

export declare function isUnexpected(
  response: TopLevelListBySubscription200Response | TopLevelListBySubscriptionDefaultResponse,
): response is TopLevelListBySubscriptionDefaultResponse;

export declare function isUnexpected(
  response: TopLevelActionSync204Response | TopLevelActionSyncDefaultResponse,
): response is TopLevelActionSyncDefaultResponse;

export declare function isUnexpected(
  response: NestedGet200Response | NestedGetDefaultResponse,
): response is NestedGetDefaultResponse;

export declare function isUnexpected(
  response:
    | NestedCreateOrReplace200Response
    | NestedCreateOrReplace201Response
    | NestedCreateOrReplaceLogicalResponse
    | NestedCreateOrReplaceDefaultResponse,
): response is NestedCreateOrReplaceDefaultResponse;

export declare function isUnexpected(
  response:
    | NestedUpdate200Response
    | NestedUpdate202Response
    | NestedUpdateLogicalResponse
    | NestedUpdateDefaultResponse,
): response is NestedUpdateDefaultResponse;

export declare function isUnexpected(
  response:
    | NestedDelete202Response
    | NestedDelete204Response
    | NestedDeleteLogicalResponse
    | NestedDeleteDefaultResponse,
): response is NestedDeleteDefaultResponse;

export declare function isUnexpected(
  response:
    | NestedListByTopLevelTrackedResource200Response
    | NestedListByTopLevelTrackedResourceDefaultResponse,
): response is NestedListByTopLevelTrackedResourceDefaultResponse;

export declare function isUnexpected(
  response: SingletonGetByResourceGroup200Response | SingletonGetByResourceGroupDefaultResponse,
): response is SingletonGetByResourceGroupDefaultResponse;

export declare function isUnexpected(
  response:
    | SingletonCreateOrUpdate200Response
    | SingletonCreateOrUpdate201Response
    | SingletonCreateOrUpdateLogicalResponse
    | SingletonCreateOrUpdateDefaultResponse,
): response is SingletonCreateOrUpdateDefaultResponse;

export declare function isUnexpected(
  response: SingletonUpdate200Response | SingletonUpdateDefaultResponse,
): response is SingletonUpdateDefaultResponse;

export declare function isUnexpected(
  response: SingletonListByResourceGroup200Response | SingletonListByResourceGroupDefaultResponse,
): response is SingletonListByResourceGroupDefaultResponse;

export declare function isUnexpected(
  response: ExtensionsResourcesGet200Response | ExtensionsResourcesGetDefaultResponse,
): response is ExtensionsResourcesGetDefaultResponse;
...
export declare function isUnexpected(
  response:
    ...
    | ExtensionsResourcesCreateOrUpdateLogicalResponse
    | ExtensionsResourcesCreateOrUpdateDefaultResponse,
): response is ExtensionsResourcesCreateOrUpdateDefaultResponse;

export declare function isUnexpected(
  response: ExtensionsResourcesUpdate200Response | ExtensionsResourcesUpdateDefaultResponse,
): response is ExtensionsResourcesUpdateDefaultResponse;
...
export declare function isUnexpected(
  response:
    ...
    | ExtensionsResourcesDelete204Response
    | ExtensionsResourcesDeleteDefaultResponse,
): response is ExtensionsResourcesDeleteDefaultResponse;

export declare function isUnexpected(
  response:
    | ExtensionsResourcesListByScope200Response
    | ExtensionsResourcesListByScopeDefaultResponse,
): response is ExtensionsResourcesListByScopeDefaultResponse;

export declare function isUnexpected(
  response: LocationResourcesGet200Response | LocationResourcesGetDefaultResponse,
): response is LocationResourcesGetDefaultResponse;

export declare function isUnexpected(
  response:
    | LocationResourcesCreateOrUpdate200Response
    | LocationResourcesCreateOrUpdate201Response
    | LocationResourcesCreateOrUpdateDefaultResponse,
): response is LocationResourcesCreateOrUpdateDefaultResponse;

export declare function isUnexpected(
  response: LocationResourcesUpdate200Response | LocationResourcesUpdateDefaultResponse,
): response is LocationResourcesUpdateDefaultResponse;

export declare function isUnexpected(
  response:
    | LocationResourcesDelete200Response
    | LocationResourcesDelete204Response
    | LocationResourcesDeleteDefaultResponse,
): response is LocationResourcesDeleteDefaultResponse;

export declare function isUnexpected(
  response:
    | LocationResourcesListByLocation200Response
    | LocationResourcesListByLocationDefaultResponse,
): response is LocationResourcesListByLocationDefaultResponse;
...
export declare type LocationResourcesCreateOrUpdateParameters =
  LocationResourcesCreateOrUpdateBodyParam & RequestParameters;
...
export declare interface LocationResourcesGet {
  get(
    options?: LocationResourcesGetParameters,
  ): StreamableMethod<LocationResourcesGet200Response | LocationResourcesGetDefaultResponse>;
  put(
    options: LocationResourcesCreateOrUpdateParameters,
  ): StreamableMethod<
    | LocationResourcesCreateOrUpdate200Response
    | LocationResourcesCreateOrUpdate201Response
    | LocationResourcesCreateOrUpdateDefaultResponse
  >;
  patch(
    options: LocationResourcesUpdateParameters,
  ): StreamableMethod<LocationResourcesUpdate200Response | LocationResourcesUpdateDefaultResponse>;
  delete(
    options?: LocationResourcesDeleteParameters,
  ): StreamableMethod<
    | LocationResourcesDelete200Response
    | LocationResourcesDelete204Response
    | LocationResourcesDeleteDefaultResponse
...
export declare interface LocationResourcesListByLocation {
  get(
    options?: LocationResourcesListByLocationParameters,
  ): StreamableMethod<
    LocationResourcesListByLocation200Response | LocationResourcesListByLocationDefaultResponse
  >;
}
...
export declare type LocationResourcesUpdateParameters = LocationResourcesUpdateBodyParam &
  RequestParameters;
...
export declare type NestedCreateOrReplaceParameters = NestedCreateOrReplaceBodyParam &
  RequestParameters;
...
export declare interface NestedGet {
  get(
    options?: NestedGetParameters,
  ): StreamableMethod<NestedGet200Response | NestedGetDefaultResponse>;
  put(
    options: NestedCreateOrReplaceParameters,
  ): StreamableMethod<
    | NestedCreateOrReplace200Response
    | NestedCreateOrReplace201Response
    | NestedCreateOrReplaceDefaultResponse
  >;
  patch(
    options: NestedUpdateParameters,
  ): StreamableMethod<
    NestedUpdate200Response | NestedUpdate202Response | NestedUpdateDefaultResponse
  >;
  delete(
    options?: NestedDeleteParameters,
  ): StreamableMethod<
    NestedDelete202Response | NestedDelete204Response | NestedDeleteDefaultResponse
  >;
}
...
export declare interface NestedListByTopLevelTrackedResource {
  get(
    options?: NestedListByTopLevelTrackedResourceParameters,
  ): StreamableMethod<
    | NestedListByTopLevelTrackedResource200Response
    | NestedListByTopLevelTrackedResourceDefaultResponse
  >;
...
export declare function paginate<TResponse extends PathUncheckedResponse>(
  client: Client,
...
export declare interface Routes {
  (
    path: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Azure.ResourceManager.Resources/topLevelTrackedResources/{topLevelTrackedResourceName}",
    subscriptionId: string,
    resourceGroupName: string,
    topLevelTrackedResourceName: string,
  ): TopLevelGet;
  (
    path: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Azure.ResourceManager.Resources/topLevelTrackedResources",
    subscriptionId: string,
    resourceGroupName: string,
  ): TopLevelListByResourceGroup;
  (
    path: "/subscriptions/{subscriptionId}/providers/Azure.ResourceManager.Resources/topLevelTrackedResources",
    subscriptionId: string,
  ): TopLevelListBySubscription;
  (
    path: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Azure.ResourceManager.Resources/topLevelTrackedResources/{topLevelTrackedResourceName}/actionSync",
    subscriptionId: string,
    resourceGroupName: string,
    topLevelTrackedResourceName: string,
  ): TopLevelActionSync;
  (
    path: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Azure.ResourceManager.Resources/topLevelTrackedResources/{topLevelTrackedResourceName}/nestedProxyResources/{nextedProxyResourceName}",
    subscriptionId: string,
    resourceGroupName: string,
    topLevelTrackedResourceName: string,
  ...
  (
    path: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Azure.ResourceManager.Resources/topLevelTrackedResources/{topLevelTrackedResourceName}/nestedProxyResources",
    subscriptionId: string,
    resourceGroupName: string,
    topLevelTrackedResourceName: string,
  ): NestedListByTopLevelTrackedResource;
  (
    path: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Azure.ResourceManager.Resources/singletonTrackedResources/default",
    subscriptionId: string,
    resourceGroupName: string,
  ): SingletonGetByResourceGroup;
  (
    path: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Azure.ResourceManager.Resources/singletonTrackedResources",
    subscriptionId: string,
    resourceGroupName: string,
  ): SingletonListByResourceGroup;
  (
    path: "/{resourceUri}/providers/Azure.ResourceManager.Resources/extensionsResources/{extensionsResourceName}",
    resourceUri: ExtensionsResourcesGetResourceUriPathParam,
    extensionsResourceName: string,
  ): ExtensionsResourcesGet;
  (
    path: "/{resourceUri}/providers/Azure.ResourceManager.Resources/extensionsResources",
    resourceUri: ExtensionsResourcesListByScopeResourceUriPathParam,
  ): ExtensionsResourcesListByScope;
  (
    path: "/subscriptions/{subscriptionId}/providers/Azure.ResourceManager.Resources/locations/{location}/locationResources/{locationResourceName}",
    subscriptionId: string,
    location: string,
    locationResourceName: string,
  ): LocationResourcesGet;
  (
    path: "/subscriptions/{subscriptionId}/providers/Azure.ResourceManager.Resources/locations/{location}/locationResources",
    subscriptionId: string,
    location: string,
  ): LocationResourcesListByLocation;
}
...
export declare type SingletonCreateOrUpdateParameters = SingletonCreateOrUpdateBodyParam &
  RequestParameters;

export declare interface SingletonGetByResourceGroup {
  get(
    options?: SingletonGetByResourceGroupParameters,
  ): StreamableMethod<
    SingletonGetByResourceGroup200Response | SingletonGetByResourceGroupDefaultResponse
  >;
  put(
    options: SingletonCreateOrUpdateParameters,
  ): StreamableMethod<
    | SingletonCreateOrUpdate200Response
    | SingletonCreateOrUpdate201Response
    | SingletonCreateOrUpdateDefaultResponse
  >;
  patch(
    options: SingletonUpdateParameters,
  ): StreamableMethod<SingletonUpdate200Response | SingletonUpdateDefaultResponse>;
}
...
export declare interface SingletonListByResourceGroup {
  get(
    options?: SingletonListByResourceGroupParameters,
  ): StreamableMethod<
    SingletonListByResourceGroup200Response | SingletonListByResourceGroupDefaultResponse
  >;
}
...
export declare interface TopLevelActionSync {
  post(
    options: TopLevelActionSyncParameters,
  ): StreamableMethod<TopLevelActionSync204Response | TopLevelActionSyncDefaultResponse>;
}
...
export declare type TopLevelCreateOrReplaceParameters = TopLevelCreateOrReplaceBodyParam &
  RequestParameters;
...
export declare interface TopLevelGet {
  get(
    options?: TopLevelGetParameters,
  ): StreamableMethod<TopLevelGet200Response | TopLevelGetDefaultResponse>;
  put(
    options: TopLevelCreateOrReplaceParameters,
  ): StreamableMethod<
    | TopLevelCreateOrReplace200Response
    | TopLevelCreateOrReplace201Response
    | TopLevelCreateOrReplaceDefaultResponse
  >;
  patch(
    options: TopLevelUpdateParameters,
  ): StreamableMethod<
    TopLevelUpdate200Response | TopLevelUpdate202Response | TopLevelUpdateDefaultResponse
  >;
  delete(
    options?: TopLevelDeleteParameters,
  ): StreamableMethod<
    TopLevelDelete202Response | TopLevelDelete204Response | TopLevelDeleteDefaultResponse
  >;
}
...
export declare interface TopLevelListByResourceGroup {
  get(
    options?: TopLevelListByResourceGroupParameters,
  ): StreamableMethod<
    TopLevelListByResourceGroup200Response | TopLevelListByResourceGroupDefaultResponse
  >;
}
...
export declare interface TopLevelListBySubscription {
  get(
    options?: TopLevelListBySubscriptionParameters,
  ): StreamableMethod<
    TopLevelListBySubscription200Response | TopLevelListBySubscriptionDefaultResponse
  >;
}
