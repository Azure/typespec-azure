...
declare function createClient({
  apiVersion,
  ...options
}?: AzureArmLargeHeaderClientOptions): AzureArmLargeHeaderClient;
...
export declare function getLongRunningPoller<
  TResult extends Two6KLogicalResponse | Two6KDefaultResponse,
>(
  client: Client,
  initialResponse: Two6K200Response | Two6K202Response | Two6KDefaultResponse,
...
export declare function isUnexpected(
  response: Two6K200Response | Two6K202Response | Two6KLogicalResponse | Two6KDefaultResponse,
): response is Two6KDefaultResponse;
...
export declare interface Two6K {
  post(
    options?: Two6KParameters,
  ): StreamableMethod<Two6K200Response | Two6K202Response | Two6KDefaultResponse>;
}
