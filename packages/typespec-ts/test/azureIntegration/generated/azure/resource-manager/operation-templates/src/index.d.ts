...
export declare interface CheckGlobal {
  post(
    options: CheckGlobalParameters,
  ): StreamableMethod<CheckGlobal200Response | CheckGlobalDefaultResponse>;
}
...
export declare interface CheckLocal {
  post(
    options: CheckLocalParameters,
  ): StreamableMethod<CheckLocal200Response | CheckLocalDefaultResponse>;
}
...
declare function createClient({
  apiVersion,
  ...options
}?: OperationTemplatesClientOptions): OperationTemplatesClient;
...
export declare interface Export {
  ...
  ): StreamableMethod<Export200Response | Export202Response | ExportDefaultResponse>;
}
...
export declare interface ExportArray {
  post(
    options: ExportArrayParameters,
  ): StreamableMethod<ExportArray200Response | ExportArray202Response | ExportArrayDefaultResponse>;
}
...
export declare function getLongRunningPoller<
  TResult extends CreateOrReplaceLogicalResponse | CreateOrReplaceDefaultResponse,
>(
  client: Client,
  initialResponse:
...
>(
  client: Client,
  initialResponse: Export200Response | Export202Response | ExportDefaultResponse,
  options?: CreateHttpPollerOptions<TResult, OperationState<TResult>>,
): Promise<SimplePollerLike<OperationState<TResult>, TResult>>;

export declare function getLongRunningPoller<
  TResult extends ExportArrayLogicalResponse | ExportArrayDefaultResponse,
>(
  client: Client,
  initialResponse: ExportArray200Response | ExportArray202Response | ExportArrayDefaultResponse,
  options?: CreateHttpPollerOptions<TResult, OperationState<TResult>>,
): Promise<SimplePollerLike<OperationState<TResult>, TResult>>;

export declare function getLongRunningPoller<
  TResult extends PostPagingLroLogicalResponse | PostPagingLroDefaultResponse,
>(
  client: Client,
  initialResponse:
    | PostPagingLro200Response
    | PostPagingLro202Response
    | PostPagingLroDefaultResponse,
  options?: CreateHttpPollerOptions<TResult, OperationState<TResult>>,
): Promise<SimplePollerLike<OperationState<TResult>, TResult>>;
...
export declare function isUnexpected(
  response: CheckGlobal200Response | CheckGlobalDefaultResponse,
): response is CheckGlobalDefaultResponse;

export declare function isUnexpected(
  response: CheckLocal200Response | CheckLocalDefaultResponse,
): response is CheckLocalDefaultResponse;
...
export declare function isUnexpected(
  response: Export200Response | Export202Response | ExportLogicalResponse | ExportDefaultResponse,
): response is ExportDefaultResponse;

export declare function isUnexpected(
  response:
    | ExportArray200Response
    | ExportArray202Response
    | ExportArrayLogicalResponse
    | ExportArrayDefaultResponse,
): response is ExportArrayDefaultResponse;

export declare function isUnexpected(
  response:
    | PostPagingLro200Response
    | PostPagingLro202Response
    | PostPagingLroLogicalResponse
    | PostPagingLroDefaultResponse,
): response is PostPagingLroDefaultResponse;
...
export declare function isUnexpected(
  response: Patch200Response | PatchDefaultResponse,
): response is PatchDefaultResponse;

export declare function isUnexpected(
  response: Post200Response | PostDefaultResponse,
): response is PostDefaultResponse;

export declare function isUnexpected(
  response: ProviderPost200Response | ProviderPostDefaultResponse,
): response is ProviderPostDefaultResponse;
...
export declare interface PostPagingLro {
  post(
    options: PostPagingLroParameters,
  ): StreamableMethod<
    PostPagingLro200Response | PostPagingLro202Response | PostPagingLroDefaultResponse
  >;
}

export declare interface PostPagingLro200Response extends HttpResponse {
  status: "200";
  body: ProductListResultOutput;
}

export declare interface PostPagingLro202Headers {
  location?: string;
  "retry-after"?: number;
}

export declare interface PostPagingLro202Response extends HttpResponse {
  status: "202";
  headers: RawHttpHeaders & PostPagingLro202Headers;
}

export declare interface PostPagingLroDefaultResponse extends HttpResponse {
  status: string;
  body: ErrorResponseOutput;
}

export declare interface PostPagingLroLogicalResponse extends HttpResponse {
  status: "200";
  body: ProductListResultOutput;
}

export declare type PostPagingLroParameters = RequestParameters;
...
export declare interface ProductListResultOutput {
  value: Array<ProductOutput>;
  nextLink?: string;
}

export declare interface ProductOutput extends TrackedResourceOutput {
...
export declare interface ProductPropertiesOutput {
  productId?: string;
  readonly provisioningState?: string;
}
...
export declare interface ProviderPost {
  post(
    options?: ProviderPostParameters,
  ): StreamableMethod<ProviderPost200Response | ProviderPostDefaultResponse>;
}
...
export declare interface Routes {
  ...
  (
    path: "/subscriptions/{subscriptionId}/providers/Azure.ResourceManager.OperationTemplates/checkNameAvailability",
    subscriptionId: string,
  ): CheckGlobal;
  (
    path: "/subscriptions/{subscriptionId}/providers/Azure.ResourceManager.OperationTemplates/locations/{location}/checkNameAvailability",
    subscriptionId: string,
    location: string,
  ): CheckLocal;
  (
    path: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Azure.ResourceManager.OperationTemplates/orders/{orderName}",
    subscriptionId: string,
    resourceGroupName: string,
    orderName: string,
  ): CreateOrReplace;
  (
    path: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Azure.ResourceManager.OperationTemplates/orders/{orderName}/export",
    subscriptionId: string,
    resourceGroupName: string,
    orderName: string,
  ): Export;
  (
    path: "/subscriptions/{subscriptionId}/providers/Azure.ResourceManager.OperationTemplates/exportArray",
    subscriptionId: string,
  ): ExportArray;
  (
    path: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Azure.ResourceManager.OperationTemplates/products/{productName}/postPagingLro",
    subscriptionId: string,
    resourceGroupName: string,
    productName: string,
  ): PostPagingLro;
  (
    path: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Azure.ResourceManager.OperationTemplates/widgets/{widgetName}",
    subscriptionId: string,
    resourceGroupName: string,
    widgetName: string,
  ): Get;
  (
    path: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Azure.ResourceManager.OperationTemplates/widgets/{widgetName}/post",
    subscriptionId: string,
    resourceGroupName: string,
    widgetName: string,
  ): Post;
  (
    path: "/subscriptions/{subscriptionId}/providers/Azure.ResourceManager.OperationTemplates/providerPost",
    subscriptionId: string,
  ): ProviderPost;
}
