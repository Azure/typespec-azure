...
declare function createClient({
  apiVersion,
  ...options
}?: PreviewVersionClientOptions): PreviewVersionClient;
...
export declare interface UpdateWidgetColor {
  patch(
    options: UpdateWidgetColorParameters,
  ): StreamableMethod<UpdateWidgetColor200Response | UpdateWidgetColor404Response>;
}
...
export declare type UpdateWidgetColorParameters = UpdateWidgetColorMediaTypesParam &
  UpdateWidgetColorBodyParam &
  RequestParameters;
...
export declare type UpdateWidgetColorRequestResourceMergeAndPatch =
  Partial<UpdateWidgetColorRequest>;
