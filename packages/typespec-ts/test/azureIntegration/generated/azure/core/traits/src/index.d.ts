...
export declare interface RepeatableAction {
  ...
  ): StreamableMethod<RepeatableAction200Response | RepeatableActionDefaultResponse>;
}
...
export declare type RepeatableActionParameters = RepeatableActionHeaderParam &
