...
export declare function isUnexpected(
  response: ListWithCustomPageModel200Response | ListWithCustomPageModelDefaultResponse,
...
export declare interface ListWithCustomPageModel {
  ...
  ): StreamableMethod<ListWithCustomPageModel200Response | ListWithCustomPageModelDefaultResponse>;
}
...
export declare type ListWithCustomPageModelParameters = ListWithCustomPageModelQueryParam &
  RequestParameters;
...
export declare interface ListWithParameters {
  ...
  ): StreamableMethod<ListWithParameters200Response | ListWithParametersDefaultResponse>;
}
...
export declare type ListWithParametersParameters = ListWithParametersQueryParam &
...
export declare interface WithParameterizedNextLink {
  get(
    options: WithParameterizedNextLinkParameters,
  ): StreamableMethod<WithParameterizedNextLink200Response>;
}
...
export declare type WithParameterizedNextLinkParameters = WithParameterizedNextLinkQueryParam &
  RequestParameters;
