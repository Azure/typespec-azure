...
export declare type CreateOrUpdateParameters = CreateOrUpdateMediaTypesParam &
...
export declare interface ExportAllUsers {
  post(
    options: ExportAllUsersParameters,
  ): StreamableMethod<ExportAllUsers200Response | ExportAllUsersDefaultResponse>;
}
...
export declare function isUnexpected(
  response: ExportAllUsers200Response | ExportAllUsersDefaultResponse,
): response is ExportAllUsersDefaultResponse;
