...
export declare interface ChildClientDeleteStandalone {
  delete(
    options?: ChildClientDeleteStandaloneParameters,
  ): StreamableMethod<ChildClientDeleteStandalone204Response>;
}
...
export declare interface ChildClientGetStandalone {
  get(
    options?: ChildClientGetStandaloneParameters,
  ): StreamableMethod<ChildClientGetStandalone200Response>;
}
...
export declare type ChildClientWithQueryParameters = ChildClientWithQueryQueryParam &
  RequestParameters;
...
export declare type HeaderParamWithBodyParameters = HeaderParamWithBodyHeaderParam &
  HeaderParamWithBodyBodyParam &
  RequestParameters;
...
export declare type HeaderParamWithQueryParameters = HeaderParamWithQueryQueryParam &
  HeaderParamWithQueryHeaderParam &
  RequestParameters;
...
export declare type MixedParamsWithBodyParameters = MixedParamsWithBodyQueryParam &
  MixedParamsWithBodyHeaderParam &
  MixedParamsWithBodyBodyParam &
  RequestParameters;
...
export declare type MixedParamsWithQueryParameters = MixedParamsWithQueryQueryParam &
  MixedParamsWithQueryHeaderParam &
  RequestParameters;
...
export declare interface MultipleParamsWithBody {
  post(
    options: MultipleParamsWithBodyParameters,
  ): StreamableMethod<MultipleParamsWithBody204Response>;
}
...
export declare type MultipleParamsWithBodyParameters = MultipleParamsWithBodyQueryParam &
  MultipleParamsWithBodyHeaderParam &
  MultipleParamsWithBodyBodyParam &
  RequestParameters;
...
export declare interface MultipleParamsWithQuery {
  get(
    options: MultipleParamsWithQueryParameters,
  ): StreamableMethod<MultipleParamsWithQuery204Response>;
}
...
export declare type MultipleParamsWithQueryParameters = MultipleParamsWithQueryQueryParam &
  MultipleParamsWithQueryHeaderParam &
  RequestParameters;
...
export declare interface ParamAliasWithAliasedName {
  get(
    options?: ParamAliasWithAliasedNameParameters,
  ): StreamableMethod<ParamAliasWithAliasedName204Response>;
}
...
export declare interface ParamAliasWithOriginalName {
  get(
    options?: ParamAliasWithOriginalNameParameters,
  ): StreamableMethod<ParamAliasWithOriginalName204Response>;
}
...
export declare interface PathParamDeleteStandalone {
  delete(
    options?: PathParamDeleteStandaloneParameters,
  ): StreamableMethod<PathParamDeleteStandalone204Response>;
}
...
export declare interface PathParamGetStandalone {
  get(
    options?: PathParamGetStandaloneParameters,
  ): StreamableMethod<PathParamGetStandalone200Response>;
}
...
export declare interface Routes {
  (
    path: "/azure/client-generator-core/client-initialization/header-param/with-query",
  ): HeaderParamWithQuery;
  (
    path: "/azure/client-generator-core/client-initialization/header-param/with-body",
  ): HeaderParamWithBody;
  (
    path: "/azure/client-generator-core/client-initialization/multiple-params/with-query",
  ): MultipleParamsWithQuery;
  (
    path: "/azure/client-generator-core/client-initialization/multiple-params/with-body",
  ): MultipleParamsWithBody;
  (
    path: "/azure/client-generator-core/client-initialization/mixed-params/with-query",
  ): MixedParamsWithQuery;
  (
    path: "/azure/client-generator-core/client-initialization/mixed-params/with-body",
  ): MixedParamsWithBody;
  (
    path: "/azure/client-generator-core/client-initialization/path/{blobName}/with-query",
    blobName: string,
  ): PathParamWithQuery;
  (
    path: "/azure/client-generator-core/client-initialization/path/{blobName}/get-standalone",
    blobName: string,
  ): PathParamGetStandalone;
  (
    path: "/azure/client-generator-core/client-initialization/path/{blobName}",
    blobName: string,
  ): PathParamDeleteStandalone;
  (
    path: "/azure/client-generator-core/client-initialization/param-alias/{blob}/with-aliased-name",
    blob: string,
  ): ParamAliasWithAliasedName;
  (
    path: "/azure/client-generator-core/client-initialization/param-alias/{blobName}/with-original-name",
    blobName: string,
  ): ParamAliasWithOriginalName;
  (
    path: "/azure/client-generator-core/client-initialization/child-client/{blobName}/with-query",
    blobName: string,
  ): ChildClientWithQuery;
  (
    path: "/azure/client-generator-core/client-initialization/child-client/{blobName}/get-standalone",
    blobName: string,
  ): ChildClientGetStandalone;
  (
    path: "/azure/client-generator-core/client-initialization/child-client/{blobName}",
    blobName: string,
  ): ChildClientDeleteStandalone;
}
