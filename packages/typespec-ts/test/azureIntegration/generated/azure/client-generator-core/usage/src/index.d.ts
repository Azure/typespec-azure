...
export declare interface NamespaceModelSerializable {
  put(
    options: NamespaceModelSerializableParameters,
  ): StreamableMethod<NamespaceModelSerializable204Response>;
}
...
export declare type NamespaceModelSerializableParameters = NamespaceModelSerializableBodyParam &
  RequestParameters;
