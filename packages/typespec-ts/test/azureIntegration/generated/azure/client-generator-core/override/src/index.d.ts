...
export declare type RemoveOptionalParameters = RemoveOptionalQueryParam &
  RemoveOptionalHeaderParam &
  RequestParameters;
...
export declare interface Routes {
  (
    path: "/azure/client-generator-core/override/reorder/{param2}/{param1}",
    param2: string,
    param1: string,
  ): Reorder;
  (path: "/azure/client-generator-core/override/group"): Group;
  (
    path: "/azure/client-generator-core/override/require-optional/{param1}/{param2}",
    param1: string,
    param2: string,
  ): RequireOptional;
  (
    path: "/azure/client-generator-core/override/remove-optional/{param1}",
    param1: string,
  ): RemoveOptional;
}
