...
export declare type OptionalExplicitOmitParameters = OptionalExplicitOmitBodyParam &
  RequestParameters;
...
export declare type OptionalExplicitSetModelParameters = OptionalExplicitSetModelBodyParam &
  RequestParameters;
