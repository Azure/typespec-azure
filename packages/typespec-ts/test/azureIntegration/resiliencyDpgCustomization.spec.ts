...
describe("ResiliencyDevDrivenClient Rest Client", () => {
  ...
  describe("resiliency with service driven", () => {
    it("should work with none parameter", async () => {
      const result11 = await client11.path("/add-optional-param/from-none").head();

      assert.equal(result11.status, "204");
      const result12 = await client12.path("/add-optional-param/from-none").head();
    ...
    it("should work with one optional parameter", async () => {
      const result11 = await client11.path("/add-optional-param/from-one-optional").get({
        queryParameters: {
          parameter: "optional",
        },
      });
      assert.equal(result11.status, "204");
      const result12 = await client12.path("/add-optional-param/from-one-optional").get({
        queryParameters: {
          parameter: "optional",
        },
      });
      assert.equal(result12.status, "204");
      const result21 = await client21.path("/add-optional-param/from-one-optional").get({
        queryParameters: {
          parameter: "optional",
          "new-parameter": "new",
        },
      ...
      assert.equal(result21.status, "204");
      const result22 = await client22.path("/add-optional-param/from-one-optional").get({
        queryParameters: {
          parameter: "optional",
          "new-parameter": "new",
        },
    ...
    it("should work with one required parameter", async () => {
      const result11 = await client11.path("/add-optional-param/from-one-required").get({
        queryParameters: {
          parameter: "required",
        },
      });
      assert.equal(result11.status, "204");
      const result12 = await client12.path("/add-optional-param/from-one-required").get({
        queryParameters: {
          parameter: "required",
        },
      });
      assert.equal(result12.status, "204");
      const result21 = await client21.path("/add-optional-param/from-one-required").get({
        queryParameters: {
          parameter: "required",
          "new-parameter": "new",
        },
      ...
      assert.equal(result21.status, "204");
      const result22 = await client22.path("/add-optional-param/from-one-required").get({
        queryParameters: {
          parameter: "required",
          "new-parameter": "new",
        },
  ...
  it("should work with add operation", async () => {
    const client122 = ServiceDrivenOldClientFactory("http://localhost:3000", "v2", {
      allowInsecureConnection: true,
      apiVersion: "v2",
    });
