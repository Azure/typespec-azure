...
export declare type ExtensibleString =
  | "and"
  | "as"
  | "assert"
  | "async"
...
export declare interface ExtensibleStringsOperations {
  putExtensibleStringValue: (
    ...
    options?: ExtensibleStringsPutExtensibleStringValueOptionalParams,
  ) => Promise<ExtensibleString>;
}
...
export declare interface ModelPropertiesOperations {
  ...
  dictMethods: (
    body: DictMethods,
    options?: ModelPropertiesDictMethodsOptionalParams,
  ) => Promise<void>;
  sameAsModel: (
    body: SameAsModel,
...
export declare interface ReservedOperationBodyParamsOperations {
  withItems: (
    items: string[],
    options?: ReservedOperationBodyParamsWithItemsOptionalParams,
  ) => Promise<void>;
}
