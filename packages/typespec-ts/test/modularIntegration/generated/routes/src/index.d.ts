import { ClientOptions, OperationOptions, Pipeline } from "@typespec/ts-http-runtime";
...
export declare interface PathParametersLabelExpansionExplodeOperations {
  record: (
    ...
    options?: PathParametersLabelExpansionExplodeRecordOptionalParams,
  ) => Promise<void>;
  array: (
    param: string[],
    options?: PathParametersLabelExpansionExplodeArrayOptionalParams,
  ) => Promise<void>;
  primitive: (
    param: string,
    options?: PathParametersLabelExpansionExplodePrimitiveOptionalParams,
  ) => Promise<void>;
}
...
export declare interface PathParametersLabelExpansionStandardOperations {
  record: (
    param: Record<string, number>,
    options?: PathParametersLabelExpansionStandardRecordOptionalParams,
  ) => Promise<void>;
  array: (
    param: string[],
    options?: PathParametersLabelExpansionStandardArrayOptionalParams,
  ) => Promise<void>;
  primitive: (
    param: string,
    options?: PathParametersLabelExpansionStandardPrimitiveOptionalParams,
  ) => Promise<void>;
}
...
export declare interface PathParametersMatrixExpansionExplodeOperations {
  record: (
    param: Record<string, number>,
    options?: PathParametersMatrixExpansionExplodeRecordOptionalParams,
  ) => Promise<void>;
  array: (
    param: string[],
    options?: PathParametersMatrixExpansionExplodeArrayOptionalParams,
  ) => Promise<void>;
  primitive: (
    param: string,
    options?: PathParametersMatrixExpansionExplodePrimitiveOptionalParams,
  ) => Promise<void>;
}
...
export declare interface PathParametersMatrixExpansionStandardOperations {
  record: (
    param: Record<string, number>,
    options?: PathParametersMatrixExpansionStandardRecordOptionalParams,
  ) => Promise<void>;
  array: (
    param: string[],
    options?: PathParametersMatrixExpansionStandardArrayOptionalParams,
  ) => Promise<void>;
  primitive: (
    param: string,
    options?: PathParametersMatrixExpansionStandardPrimitiveOptionalParams,
  ) => Promise<void>;
}
...
export declare interface PathParametersOperations {
  annotationOnly: (
    param: string,
    options?: PathParametersAnnotationOnlyOptionalParams,
  ) => Promise<void>;
  explicit: (param: string, options?: PathParametersExplicitOptionalParams) => Promise<void>;
  templateOnly: (
    param: string,
    options?: PathParametersTemplateOnlyOptionalParams,
  ) => Promise<void>;
...
export declare interface PathParametersPathExpansionExplodeOperations {
  record: (
    param: Record<string, number>,
    options?: PathParametersPathExpansionExplodeRecordOptionalParams,
  ) => Promise<void>;
  array: (
    param: string[],
    options?: PathParametersPathExpansionExplodeArrayOptionalParams,
  ) => Promise<void>;
  primitive: (
    param: string,
    options?: PathParametersPathExpansionExplodePrimitiveOptionalParams,
  ) => Promise<void>;
}
...
export declare interface PathParametersPathExpansionStandardOperations {
  record: (
    param: Record<string, number>,
    options?: PathParametersPathExpansionStandardRecordOptionalParams,
  ) => Promise<void>;
  array: (
    param: string[],
    options?: PathParametersPathExpansionStandardArrayOptionalParams,
  ) => Promise<void>;
  primitive: (
    param: string,
    options?: PathParametersPathExpansionStandardPrimitiveOptionalParams,
  ) => Promise<void>;
}
...
export declare interface PathParametersReservedExpansionOperations {
  annotation: (
    param: string,
    options?: PathParametersReservedExpansionAnnotationOptionalParams,
  ) => Promise<void>;
  template: (
    param: string,
    options?: PathParametersReservedExpansionTemplateOptionalParams,
  ) => Promise<void>;
}
...
export declare interface PathParametersSimpleExpansionExplodeOperations {
  record: (
    param: Record<string, number>,
    options?: PathParametersSimpleExpansionExplodeRecordOptionalParams,
  ) => Promise<void>;
  array: (
    param: string[],
    options?: PathParametersSimpleExpansionExplodeArrayOptionalParams,
  ) => Promise<void>;
  primitive: (
    param: string,
    options?: PathParametersSimpleExpansionExplodePrimitiveOptionalParams,
  ) => Promise<void>;
}
...
export declare interface PathParametersSimpleExpansionStandardOperations {
  record: (
    param: Record<string, number>,
    options?: PathParametersSimpleExpansionStandardRecordOptionalParams,
  ) => Promise<void>;
  array: (
    param: string[],
    options?: PathParametersSimpleExpansionStandardArrayOptionalParams,
  ) => Promise<void>;
  primitive: (
    param: string,
    options?: PathParametersSimpleExpansionStandardPrimitiveOptionalParams,
  ) => Promise<void>;
}
...
export declare interface QueryParametersOperations {
  annotationOnly: (
    param: string,
    options?: QueryParametersAnnotationOnlyOptionalParams,
  ) => Promise<void>;
  explicit: (param: string, options?: QueryParametersExplicitOptionalParams) => Promise<void>;
  templateOnly: (
    param: string,
    options?: QueryParametersTemplateOnlyOptionalParams,
  ) => Promise<void>;
...
export declare interface QueryParametersQueryContinuationExplodeOperations {
  record: (
    param: Record<string, number>,
    options?: QueryParametersQueryContinuationExplodeRecordOptionalParams,
  ) => Promise<void>;
  array: (
    param: string[],
    options?: QueryParametersQueryContinuationExplodeArrayOptionalParams,
  ) => Promise<void>;
  primitive: (
    param: string,
    options?: QueryParametersQueryContinuationExplodePrimitiveOptionalParams,
  ) => Promise<void>;
}
...
export declare interface QueryParametersQueryContinuationStandardOperations {
  record: (
    param: Record<string, number>,
    options?: QueryParametersQueryContinuationStandardRecordOptionalParams,
  ) => Promise<void>;
  array: (
    param: string[],
    options?: QueryParametersQueryContinuationStandardArrayOptionalParams,
  ) => Promise<void>;
  primitive: (
    param: string,
    options?: QueryParametersQueryContinuationStandardPrimitiveOptionalParams,
  ) => Promise<void>;
}
...
export declare interface QueryParametersQueryExpansionExplodeOperations {
  record: (
    param: Record<string, number>,
    options?: QueryParametersQueryExpansionExplodeRecordOptionalParams,
  ) => Promise<void>;
  array: (
    param: string[],
    options?: QueryParametersQueryExpansionExplodeArrayOptionalParams,
  ) => Promise<void>;
  primitive: (
    param: string,
    options?: QueryParametersQueryExpansionExplodePrimitiveOptionalParams,
  ) => Promise<void>;
}
...
export declare interface QueryParametersQueryExpansionStandardOperations {
  record: (
    param: Record<string, number>,
    options?: QueryParametersQueryExpansionStandardRecordOptionalParams,
  ) => Promise<void>;
  array: (
    param: string[],
    options?: QueryParametersQueryExpansionStandardArrayOptionalParams,
  ) => Promise<void>;
  primitive: (
    param: string,
    options?: QueryParametersQueryExpansionStandardPrimitiveOptionalParams,
  ) => Promise<void>;
}
