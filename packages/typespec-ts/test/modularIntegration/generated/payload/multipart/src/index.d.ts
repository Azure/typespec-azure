...
export declare interface FormDataFileOperations {
  uploadFileArray: (
    ...
    options?: FormDataFileUploadFileArrayOptionalParams,
  ) => Promise<void>;
  uploadFileRequiredFilename: (
    ...
    options?: FormDataFileUploadFileRequiredFilenameOptionalParams,
  ) => Promise<void>;
  uploadFileSpecificContentType: (
    ...
    options?: FormDataFileUploadFileSpecificContentTypeOptionalParams,
  ) => Promise<void>;
}
...
export declare interface FormDataOperations {
  ...
  optionalParts: (
    ...
    options?: FormDataOptionalPartsOptionalParams,
  ) => Promise<void>;
  withWireName: (
    body: MultiPartRequestWithWireName,
    options?: FormDataWithWireNameOptionalParams,
  ) => Promise<void>;
