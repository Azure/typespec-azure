...
export declare interface PageSizeOperations {
  listWithPageSize: (
    options?: PageSizeListWithPageSizeOptionalParams,
  ) => PagedAsyncIterableIterator<Pet>;
  listWithoutContinuation: (
    options?: PageSizeListWithoutContinuationOptionalParams,
  ) => PagedAsyncIterableIterator<Pet>;
}
...
export declare interface ServerDrivenPaginationAlternateInitialVerbOperations {
  post: (
    body: Filter,
    options?: ServerDrivenPaginationAlternateInitialVerbPostOptionalParams,
  ) => PagedAsyncIterableIterator<Pet>;
}
...
export declare interface ServerDrivenPaginationContinuationTokenOperations {
  requestHeaderNestedResponseBody: (
    options?: ServerDrivenPaginationContinuationTokenRequestHeaderNestedResponseBodyOptionalParams,
  ) => PagedAsyncIterableIterator<Pet>;
  requestQueryNestedResponseBody: (
    options?: ServerDrivenPaginationContinuationTokenRequestQueryNestedResponseBodyOptionalParams,
  ) => PagedAsyncIterableIterator<Pet>;
  requestHeaderResponseHeader: (
    options?: ServerDrivenPaginationContinuationTokenRequestHeaderResponseHeaderOptionalParams,
  ) => PagedAsyncIterableIterator<Pet>;
  requestQueryResponseHeader: (
    options?: ServerDrivenPaginationContinuationTokenRequestQueryResponseHeaderOptionalParams,
  ) => PagedAsyncIterableIterator<Pet>;
...
export declare interface ServerDrivenPaginationOperations {
  nestedLink: (
    options?: ServerDrivenPaginationNestedLinkOptionalParams,
  ) => PagedAsyncIterableIterator<Pet>;
  linkString: (
    options?: ServerDrivenPaginationLinkStringOptionalParams,
  ) => PagedAsyncIterableIterator<Pet>;
...
export declare interface XmlPaginationOperations {
  listWithNextLink: (
    options?: XmlPaginationListWithNextLinkOptionalParams,
  ) => PagedAsyncIterableIterator<XmlPet>;
  listWithContinuation: (
    options?: XmlPaginationListWithContinuationOptionalParams,
  ) => PagedAsyncIterableIterator<XmlPet>;
}
