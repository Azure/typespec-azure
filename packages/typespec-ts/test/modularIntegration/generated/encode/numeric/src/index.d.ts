...
export declare interface PropertyOperations {
  uint8AsString: (
    value: Uint8AsStringProperty,
    options?: PropertyUint8AsStringOptionalParams,
  ) => Promise<Uint8AsStringProperty>;
  uint32AsStringOptional: (
    value: Uint32AsStringProperty,
    options?: PropertyUint32AsStringOptionalOptionalParams,
  ) => Promise<Uint32AsStringProperty>;
  safeintAsString: (
    value: SafeintAsStringProperty,
    options?: PropertySafeintAsStringOptionalParams,
  ) => Promise<SafeintAsStringProperty>;
}
