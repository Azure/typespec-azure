...
export declare interface HeaderOperations {
  int32MillisecondsArray: (
    duration: number[],
    options?: HeaderInt32MillisecondsArrayOptionalParams,
  ) => Promise<void>;
  float64Milliseconds: (
    duration: number,
    options?: HeaderFloat64MillisecondsOptionalParams,
  ) => Promise<void>;
  floatMillisecondsLargerUnit: (
    duration: number,
    options?: HeaderFloatMillisecondsLargerUnitOptionalParams,
  ) => Promise<void>;
  floatMilliseconds: (
    duration: number,
    options?: HeaderFloatMillisecondsOptionalParams,
  ) => Promise<void>;
  int32MillisecondsLargerUnit: (
    duration: number,
    options?: HeaderInt32MillisecondsLargerUnitOptionalParams,
  ) => Promise<void>;
  int32Milliseconds: (
    duration: number,
    options?: HeaderInt32MillisecondsOptionalParams,
  ) => Promise<void>;
  float64Seconds: (duration: number, options?: HeaderFloat64SecondsOptionalParams) => Promise<void>;
  floatSecondsLargerUnit: (
    duration: number,
    options?: HeaderFloatSecondsLargerUnitOptionalParams,
  ) => Promise<void>;
  floatSeconds: (duration: number, options?: HeaderFloatSecondsOptionalParams) => Promise<void>;
  int32SecondsLargerUnit: (
    duration: number,
    options?: HeaderInt32SecondsLargerUnitOptionalParams,
  ) => Promise<void>;
...
export declare interface PropertyOperations {
  floatMillisecondsLargerUnit: (
    ...
    options?: PropertyFloatMillisecondsLargerUnitOptionalParams,
  ) => Promise<FloatMillisecondsLargerUnitDurationProperty>;
  int32MillisecondsLargerUnit: (
    body: Int32MillisecondsLargerUnitDurationProperty,
    options?: PropertyInt32MillisecondsLargerUnitOptionalParams,
  ) => Promise<Int32MillisecondsLargerUnitDurationProperty>;
  floatSecondsLargerUnit: (
    body: FloatSecondsLargerUnitDurationProperty,
    options?: PropertyFloatSecondsLargerUnitOptionalParams,
  ) => Promise<FloatSecondsLargerUnitDurationProperty>;
  int32SecondsLargerUnit: (
    body: Int32SecondsLargerUnitDurationProperty,
    options?: PropertyInt32SecondsLargerUnitOptionalParams,
  ) => Promise<Int32SecondsLargerUnitDurationProperty>;
  floatMillisecondsArray: (
    body: FloatMillisecondsDurationArrayProperty,
    options?: PropertyFloatMillisecondsArrayOptionalParams,
  ) => Promise<FloatMillisecondsDurationArrayProperty>;
  floatSecondsArray: (
  ...
  float64Milliseconds: (
    ...
    options?: PropertyFloat64MillisecondsOptionalParams,
  ) => Promise<Float64MillisecondsDurationProperty>;
  floatMilliseconds: (
    body: FloatMillisecondsDurationProperty,
    options?: PropertyFloatMillisecondsOptionalParams,
  ) => Promise<FloatMillisecondsDurationProperty>;
  int32Milliseconds: (
    body: Int32MillisecondsDurationProperty,
    options?: PropertyInt32MillisecondsOptionalParams,
  ) => Promise<Int32MillisecondsDurationProperty>;
  float64Seconds: (
...
export declare interface QueryOperations {
  int32MillisecondsArray: (
    input: number[],
    options?: QueryInt32MillisecondsArrayOptionalParams,
  ) => Promise<void>;
  int32SecondsArray: (
    input: number[],
  ...
  float64Milliseconds: (
    input: number,
    options?: QueryFloat64MillisecondsOptionalParams,
  ) => Promise<void>;
  floatMillisecondsLargerUnit: (
    input: number,
    options?: QueryFloatMillisecondsLargerUnitOptionalParams,
  ) => Promise<void>;
  floatMilliseconds: (
    input: number,
    options?: QueryFloatMillisecondsOptionalParams,
  ) => Promise<void>;
  int32MillisecondsLargerUnit: (
    input: number,
    options?: QueryInt32MillisecondsLargerUnitOptionalParams,
  ) => Promise<void>;
  int32Milliseconds: (
    input: number,
    options?: QueryInt32MillisecondsOptionalParams,
  ) => Promise<void>;
  float64Seconds: (input: number, options?: QueryFloat64SecondsOptionalParams) => Promise<void>;
  floatSecondsLargerUnit: (
    input: number,
    options?: QueryFloatSecondsLargerUnitOptionalParams,
  ) => Promise<void>;
  floatSeconds: (input: number, options?: QueryFloatSecondsOptionalParams) => Promise<void>;
  int32SecondsLargerUnit: (
    input: number,
    options?: QueryInt32SecondsLargerUnitOptionalParams,
  ) => Promise<void>;
