...
export declare interface PropertyOperations {
  extensibleEnumNewlineDelimited: (
    body: NewlineDelimitedExtensibleEnumArrayProperty,
    options?: PropertyExtensibleEnumNewlineDelimitedOptionalParams,
  ) => Promise<NewlineDelimitedExtensibleEnumArrayProperty>;
  extensibleEnumPipeDelimited: (
    body: PipeDelimitedExtensibleEnumArrayProperty,
    options?: PropertyExtensibleEnumPipeDelimitedOptionalParams,
  ) => Promise<PipeDelimitedExtensibleEnumArrayProperty>;
  extensibleEnumSpaceDelimited: (
    body: SpaceDelimitedExtensibleEnumArrayProperty,
    options?: PropertyExtensibleEnumSpaceDelimitedOptionalParams,
  ) => Promise<SpaceDelimitedExtensibleEnumArrayProperty>;
  extensibleEnumCommaDelimited: (
    body: CommaDelimitedExtensibleEnumArrayProperty,
    options?: PropertyExtensibleEnumCommaDelimitedOptionalParams,
  ) => Promise<CommaDelimitedExtensibleEnumArrayProperty>;
  enumNewlineDelimited: (
    body: NewlineDelimitedEnumArrayProperty,
    options?: PropertyEnumNewlineDelimitedOptionalParams,
  ) => Promise<NewlineDelimitedEnumArrayProperty>;
  enumPipeDelimited: (
    body: PipeDelimitedEnumArrayProperty,
    options?: PropertyEnumPipeDelimitedOptionalParams,
  ) => Promise<PipeDelimitedEnumArrayProperty>;
  enumSpaceDelimited: (
    body: SpaceDelimitedEnumArrayProperty,
    options?: PropertyEnumSpaceDelimitedOptionalParams,
  ) => Promise<SpaceDelimitedEnumArrayProperty>;
  enumCommaDelimited: (
    body: CommaDelimitedEnumArrayProperty,
    options?: PropertyEnumCommaDelimitedOptionalParams,
  ) => Promise<CommaDelimitedEnumArrayProperty>;
  newlineDelimited: (
    body: NewlineDelimitedArrayProperty,
    options?: PropertyNewlineDelimitedOptionalParams,
  ) => Promise<NewlineDelimitedArrayProperty>;
  pipeDelimited: (
    body: PipeDelimitedArrayProperty,
    options?: PropertyPipeDelimitedOptionalParams,
  ) => Promise<PipeDelimitedArrayProperty>;
  spaceDelimited: (
    body: SpaceDelimitedArrayProperty,
    options?: PropertySpaceDelimitedOptionalParams,
  ) => Promise<SpaceDelimitedArrayProperty>;
  commaDelimited: (
    body: CommaDelimitedArrayProperty,
    options?: PropertyCommaDelimitedOptionalParams,
  ) => Promise<CommaDelimitedArrayProperty>;
}
