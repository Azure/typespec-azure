...
import { createTCGCContext, TCGCContext, DuplicateTracker } from "./internal-utils.js";
import { reportDiagnostic, createStateSymbol } from "./lib.js";
import { getClientNameOverride, AllScopes } from "./decorators.js";
...
function validateModels(program: Program, tcgcContext: TCGCContext, languageScopes: Set<string | symbol>) {
