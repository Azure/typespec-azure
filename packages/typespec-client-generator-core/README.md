...
| [`@azure-tools/typespec-client-generator-core/require-named-model`](https://azure.github.io/typespec-azure/docs/libraries/typespec-client-generator-core/rules/require-named-model)       | Requires models to be named rather than defined anonymously or inline.  |
