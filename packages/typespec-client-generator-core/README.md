...
| [`@azure-tools/typespec-client-generator-core/use-union-hierarchy`](https://azure.github.io/typespec-azure/docs/libraries/typespec-client-generator-core/rules/use-union-hierarchy)                   | Named unions should declare an extends constraint, with model variants inheriting from the base and belonging to only one union hierarchy. |
