...
| [`@azure-tools/typespec-client-generator-core/use-client-namespace-isolation`](https://azure.github.io/typespec-azure/docs/libraries/typespec-client-generator-core/rules/use-client-namespace-isolation) | Keep client.tsp types in an isolated client namespace.                                          |
