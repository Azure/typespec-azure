...
| [`@azure-tools/typespec-client-generator-core/duplicate-names`](https://azure.github.io/typespec-azure/docs/libraries/typespec-client-generator-core/rules/duplicate-names)               | Detects duplicate type names across namespaces that would cause naming conflicts in generated SDKs. |
