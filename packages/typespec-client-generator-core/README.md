...
| [`@azure-tools/typespec-client-generator-core/no-service-namespace-redefinition`](https://azure.github.io/typespec-azure/docs/libraries/typespec-client-generator-core/rules/no-service-namespace-redefinition) | Prevent client.tsp from redefining the service namespace.                                       |
