...
| [`@azure-tools/typespec-client-generator-core/use-model-inheritance`](https://azure.github.io/typespec-azure/docs/libraries/typespec-client-generator-core/rules/use-model-inheritance)               | Model variants of a union with a model extends constraint should explicitly inherit from the base model. |
