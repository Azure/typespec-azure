...
| [`@azure-tools/typespec-client-generator-core/csharp-no-type-name-conflict`](https://azure.github.io/typespec-azure/docs/libraries/typespec-client-generator-core/rules/csharp-no-type-name-conflict) | C# generated type names should not conflict with reserved Azure SDK type names.                 |
