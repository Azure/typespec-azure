...
describe("typespec-service-csharp: diagnostics", () => {
  ...
  it("warns for custom scalars", async () => {
    ...
    expectDiagnostics(diagnostics, [
      {
        code: "@azure-tools/typespec-service-csharp/unrecognized-scalar",
        message:
  ...
  it("warns for integer", async () => {
    ...
    expectDiagnostics(diagnostics, [
      {
        code: "@azure-tools/typespec-service-csharp/no-numeric",
        message:
  ...
  it("warns for invalid identifiers", async () => {
    ...
    expectDiagnostics(diagnostics, [
      {
        code: "@azure-tools/typespec-service-csharp/invalid-identifier",
        message:
