...
export default {
  enable: {
    // Azure core
    "@azure-tools/typespec-azure-core/operation-missing-api-version": false,
    "@azure-tools/typespec-azure-core/auth-required": false,
    ...
    "@azure-tools/typespec-azure-resource-manager/arm-no-record": false,
    ...
    "@azure-tools/typespec-azure-resource-manager/arm-delete-operation-response-codes": false,
    "@azure-tools/typespec-azure-resource-manager/arm-put-operation-response-codes": false,
    "@azure-tools/typespec-azure-resource-manager/arm-post-operation-response-codes": false,
    ...
    "@azure-tools/typespec-azure-resource-manager/arm-resource-invalid-envelope-property": false,
    ...
    "@azure-tools/typespec-azure-resource-manager/arm-resource-name-pattern": false,
    ...
    "@azure-tools/typespec-azure-resource-manager/arm-resource-provisioning-state": false,
    "@azure-tools/typespec-azure-resource-manager/beyond-nesting-levels": false,
    "@azure-tools/typespec-azure-resource-manager/arm-resource-operation": true,
    "@azure-tools/typespec-azure-resource-manager/no-resource-delete-operation": false,
    "@azure-tools/typespec-azure-resource-manager/empty-updateable-properties": true,
    "@azure-tools/typespec-azure-resource-manager/arm-resource-interface-requires-decorator": false,
    "@azure-tools/typespec-azure-resource-manager/arm-resource-invalid-action-verb": true,
    "@azure-tools/typespec-azure-resource-manager/improper-subscription-list-operation": false,
    "@azure-tools/typespec-azure-resource-manager/lro-location-header": false,
    "@azure-tools/typespec-azure-resource-manager/missing-x-ms-identifiers": false,
    "@azure-tools/typespec-azure-resource-manager/no-response-body": true,
    "@azure-tools/typespec-azure-resource-manager/missing-operations-endpoint": false,
    "@azure-tools/typespec-azure-resource-manager/patch-envelope": false,
    ...
    "@azure-tools/typespec-azure-resource-manager/secret-prop": false,
