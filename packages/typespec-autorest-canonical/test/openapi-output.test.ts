...
describe("typespec-autorestcanonical: definitions", () => {
...
describe("typespec-autorestcanonical: literals", () => {
  const cases = [
...
describe("typespec-autorestcanonical: operations", () => {
...
describe("typespec-autorestcanonical: request", () => {
...
describe("typespec-autorestcanonical: enums", () => {
...
describe("typespec-autorestcanonical: multipart formData", () => {
